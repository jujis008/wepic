...
public class PublishAction2 extends PageAction {
	...
	public String insert() throws Exception {
		...
		publish.setUser(this.getUserService().select(this.getUserId()));  //userInstance  
	...
	public String getUserId(){
		try{
			if(userId == null){
				userId = this.getUserService().select(getUsername()).getId().toString();
			}
		}catch(Exception e){
			e.printStackTrace();
		}
