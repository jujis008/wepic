...
public class PictureUtil {
	        ...
	        */   
	        ...
	        public void produceSmallPicUnderDir(String fullPathOfDir){
	        	File fileDir = new File(fullPathOfDir);
	        	for(File file : fileDir.listFiles()){
	        		if(file.isDirectory()){
	        			continue;
	        		}
	        		String  fileName = file.getName();
	        		String picType = fileName.substring(fileName.lastIndexOf(".")+1).toLowerCase();
	        		if(picType.indexOf("jpg") < 0){
	        			continue;
	        		}
	    			...
	    			try {
	    				SetScale(0.7);  
			            SetSmallHeight(100); 
						doFinal(fullPathOfDir + fileName,fullPathOfDir + picName+"_small."+picType);
...
//		File f = new File("images/118.jpg");
...
//        try {  
//            j.SetScale(10);  
//            j.SetSmallHeight(800);  
//            j.doFinal("D:\\images\\abc.jpg","D:\\images\\abc_small.jpg");  
//        } catch (JpegToolException e) {  
//            // TODO Auto-generated catch block  
//            e.printStackTrace();  
//        }  
//		//j.produceSmallPicUnderDir("D:/Java/apache-tomcat-6.0.26/webapps/goodChance/index2013_files/");
//    }//end main()  
