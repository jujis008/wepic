...
public class SendEmail {
	...
	public SendEmail(Map<String,String> map,List<String> filelist,Map<String,String> image){  
    ...
    public MimeMessage createMessage(Session session)throws Exception{  
        ...
        Address address = new InternetAddress( this.from,"唯图网客服中心");
    ...
    public void activeMail(String email) throws Exception {
