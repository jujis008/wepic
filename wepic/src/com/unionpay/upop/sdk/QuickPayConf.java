...
public class QuickPayConf {
 ...
 // private final static String UPOP_BSPAY_BASE_URL = "http://www.epay.lxdns.com/UpopWeb/api/";
	...
	// 支付网址
	public final static String gateWay = UPOP_BASE_URL + "Pay.action";//支付网址
	...
	// 商户代码
	public final static String merCode = "301310048990146";

	// 商户名称
	public final static String merName = "上海维拓网络科技有限公司";

	public final static String merFrontEndUrl = "http://www.wepic.cn/resIndex.jsp";

	public final static String merBackEndUrl = "http://www.wepic.cn/accountRecharge!chinaPayReturn.do";//回调url

	// 加密方式
	public final static String signType = "MD5";
	public final static String signType_SHA1withRSA = "SHA1withRSA";

	// 商城密匙，需要和银联商户网站谁顶顶顶宿舍上配置的一样
	public final static String securityKey = "WE89UREOJMDSOJCFSDJGOJ49UOSEFDOJ584";
