...
public class SimpleUploader {
	...
	public SimpleUploader(HttpServletRequest request) {
	...
	String[] s=url.split("jsp");
	  String url1=s[1].replace("\\", "//");
		return url1;
	}
	private String getPhysicalPath(String path) {
		String servletPath = this.request.getRealPath("/jsp");
