...
function submitPopBox(){
		...
		var id=$("#divViewRe").find(".active").attr("id");
		if(id==null||id==""){
			alert("请选择素材图片");
             return;
			}
		...
		// alert(id);
		window.parent.changePicfromMylib(id);//openPopUpBox(addValue);
...
<body>
 ...
 <!--代表作eeee品弹出框-->
    <div class="rework" id="divChooseWorkPop">
     ...
     <form action="searchPublishPic!searchByTermfromMylibforUserPic.do" method="post" id="searchByTermfromMylib">
