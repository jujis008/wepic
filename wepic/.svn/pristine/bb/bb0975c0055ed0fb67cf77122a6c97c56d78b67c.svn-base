...
<title>wepic管理员_用户_企业组织列表</title>
...
<style>
.container_body .div_container table .td_laterOne .td_div_two .userPositionAddress {
    margin-left: 0px;
	}
</style>
</head>
...
<!-- 头部结束-->
  	...
  	<div id="assistantBar">
        ...
        <div id="divThreeStage">
            ...
            <div class="threeStage">
                ...
                <a href="<%=basePath %>configure!adminorganizationlist.do"><div class='bar active'><span>机构</span><i></i></div></a>
    ...
    <div class="container_body">
        <div class="div_job">
           <div class="div_left">机构用户列表</div>
            
           <div class="all_job" id="allJobFiltrate">
           <s:if test="flag ==0">
           <div class='bar active' onclick="adminuserorganizationofflag(0)"><span>全部机构</span><i></i></div>
           </s:if>
           <s:else>
           <div class='bar' onclick="adminuserorganizationofflag(0)"><span>全部机构</span><i></i></div>
           </s:else>
           <s:if test="flag ==1">
           <div class='bar active' onclick="adminuserorganizationofflag(1)"><span>政府机构</span><i></i></div>
           </s:if>
           <s:else>
           <div class='bar' onclick="adminuserorganizationofflag(1)"><span>政府机构</span><i></i></div>
           </s:else>
           <s:if test="flag ==2">
           <div class='bar active' onclick="adminuserorganizationofflag(2)"><span>企业</span><i></i></div>
           </s:if>
           <s:else>
           <div class='bar' onclick="adminuserorganizationofflag(2)"><span>企业</span><i></i></div>
           </s:else>
           <s:if test="flag ==3">
           <div class='bar active' onclick="adminuserorganizationofflag(3)"><span>媒体</span><i></i></div>
           </s:if>
           <s:else>
           <div class='bar' onclick="adminuserorganizationofflag(3)"><span>媒体</span><i></i></div>
           </s:else>
           <s:if test="flag ==4">
           <div class='bar active' onclick="adminuserorganizationofflag(4)"><span>其他组织</span><i></i></div>
           </s:if>
           <s:else>
          <div class='bar' onclick="adminuserorganizationofflag(4)"><span>其他组织</span><i></i></div>
           </s:else>
          </div>
            	...
            	<tr>
                	<td class="td_one">
                    	...
                    	<s:else>
                         ...
                         <div class="info">
                            ...
                            <div class="name">
                                <span class="namechar" title="名字全称"><s:property value="#list.companyName"/></span>
                    ...
                    <td class="td_laterTwo">
                    	<div class="td_div_one">
                        	...
                        	<span><s:property value="#list.markerName"/></span>
                        	</s:if>
                        </div>
                        <div class="td_div_two">
                        	<span>手机：</span>
