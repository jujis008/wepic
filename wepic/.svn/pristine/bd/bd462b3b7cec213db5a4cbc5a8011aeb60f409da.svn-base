...
<title>wepic管理_配置中心_账户安全_基本安全信息_修改密码_成功</title>
...
function relogin(){
location.href="http://www.wepic.cn:81/wepic/back/loginRegister/login.jsp";
}
</script>
<style>
.container_body .info_detail .info_password .info_success{
	width: 470px;
	}
</style>
</head>
            ...
            <div class="info_password">
            	<div class="info_success">
                	...
                	<div class="success_right">
                    	...
                    	<div class="remin">请牢记您的新密码，以保证您的各种财产信息安全！</div>
                    </div>
                </div>
            	
                                
                <div class="password_three">
                    <input type="button" value="重新登录"  class="login_submit" onclick="relogin()"/>
                </div>
            </div>
        </div>
