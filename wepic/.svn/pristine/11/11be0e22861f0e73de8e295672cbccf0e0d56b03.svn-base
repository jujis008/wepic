...
<title>wepic管理 个人中心 账户基本资料 个人版</title>
...
<!-- 头部结束-->
    ...
    <!--内容-->
    <div id="divtPersonInfo">
    <form  id="formPersonInfo" action="${pageContext.request.contextPath}/user!updetaUserBaseInfo.do" method="post">
    	<div class="title">
        	<h2>基本信息</h2>
        </div>
        ...
        <div class="content">
            ...
            <div class="nickname">
            	...
            	<input type="text"  class="inputNickname" name="nickName" value="<s:property value="user.username"/>"/>
            </div>
             ...
             <div class="birthDay">
                ...
                <div class="editSelect" id="divSelectBirthDayMonth">
                    <div  class="viewBelow" onclick="showBelow('divSelectBirthDayMonthValue')">
                        <div id="selectBirthDayMonthValue">
            ...
            <div class="sexAgeSx">
        		<span class="left">性别</span>
                   <input type="text" name="sex" id="sexId" value='<s:property value="user.sex" escape='false'/>' style="display: none"/>
            ...
            <div class="address homeTown">
        		...
        		<input type="text" name="homeTown" id="homeTownId" value='<s:property value="user.homeTown" escape='false'/>' style="display: none"  />
                <div class="adr" id="citySelectTag">
                    <dl class="dl1">
                        <dt>
                            <span class="arr"></span>
                            <div class="xl"><i></i></div> 
                            <input name="Area_province" type="hidden" value='<s:property value="#detalfor.sheng"/>' id="homeP" />
                        </dt><dd></dd>
                    </dl>
                    <dl class="dl2">
                        <dt>
                        	<span class="arr"></span>
                            <div class="xl"><i></i></div> 
                        	<input name="Area_city" type="hidden" value='<s:property value="#detalfor.city"/>' id="homeCity" />
                        </dt><dd></dd>
                    </dl>
                    <dl class="dl3">
                        <dt>
            ...
            <div class="address">
        		...
        		<input type="text" name="workPlace" id="workPlaceId" value='<s:property value="user.workPlace" escape='false'/>'   style="display: none"/>
