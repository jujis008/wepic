...
<title>wepic管理_个人中心_账户基本资料_个人版_模特</title>
<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/back/personalCentr/user/css/accountMyPart.css" />


<script type="text/javascript" src="${pageContext.request.contextPath}/public/js/jquery.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/back/personalCentr/user/js/accountMyPart.js"></script>
<!--公共js-->
...
function  getRandom(){
  $.ajax({
       type:"post",
       url:"${pageContext.request.contextPath}/frontlogin_ajaxgetRandomRoleTag.do",
       data:"",
       success:function(data){
           var tags=data.roleTags;
           var htm="";
           for(var i=0;i<tags.length;i++){
            htm+='<div class="othtag"><span>'+tags[i].tag+'</span><a title="增加" onclick=addOtherTag(this,"divAddEnTagpho")></a></div>';
               }
           $("#divAddOtherTag").html(htm)
      }
 ...
 <div class="threeStage">
       <s:if test="#session.personOrCompany==2">
        <a href="${pageContext.request.contextPath}/user!baseUseInfo.do?message=enpr"><div id="enterpriseInfo" class="tag">企业信息</div></a>
            ...
            <a href="${pageContext.request.contextPath}/user!findroleTagsbyrole.do"> <div id="myTag" class="active tag">我的标签</div></a>
    ...
    <!--内容-->
    <div id="divAccountMyPart">
    <div id="divAccountPartTag" class="chooseTag">
    <form  id="formAccountPartTag">
    	<div class="title">
        	<h2>职业标签</h2>
        ...
        <div class="occupation">
        	<span class="cen">主职业标签</span>
            <div class='tagDe'>
           
            <span>
            <s:property value="user.chineseRole"/>
            </span>
        ...
        <div class="choosed">
    		<div class="one">其他职业标签</div>
        	<div class="con">
        		<div id="divAddEnTagpho">
            		
                    <s:iterator value="#request.usetaglist" status="rowstatus">
                    <s:iterator value="#request.usetaglist[#rowstatus.index]" >
                     
                       <div class="retag"><span>  <s:property/>  </span><a title='删除' onclick="deleteProModel(this);"></a></div>
                     </s:iterator>
                      </s:iterator>
    ...
    <div class="chooseCon">
    	<div class="one">可能与您职业符合的标签:</div>
        <div class="con">
        <div id="divAddReTag">
        <s:iterator value="#request.roleTags2">
        
            <div class="retag"><span><s:property value="tag.trim()"/>  </span><a title='增加' onclick="addreProfTag(this,'divAddEnTagpho');"></a></div>
            </s:iterator>
        </div>
            <div style="clear:both;"></div>
        </div>
    ...
    <div class="chooseCon">
    	<div class="one">您还可以选择的标签：<a href="javascript:void(0)" onclick="getRandom()">换一组</a></div>
        <div class="con">
        <div id="divAddOtherTag">
         <s:iterator value="#request.roleTags3">
        	<div class="othtag"><span><s:property value="tag.trim()"/></span><a title='增加' onclick="addOtherTag(this,'divAddEnTagpho');"></a></div>
           </s:iterator>
        </div>
            <div style="clear:both;"></div>
        </div>
    ...
    <div id="divAccountPersonTag">
    	<form  id="formAccountPersonTag"  action="user!updateUserTag.do" method="post" class="chooseTagM">
        	<div class="title">
        		<h2>个人标签</h2>
        		<input type="hidden" id="hiddenReTags"  name="userTag" value="<s:property value="user.userTag"/>"/>
                    <input type="hidden" id="hiddenOtherTags" name="" />
                    <input type="hidden" id="hiddenUserTags" name="personTag" value="<s:property value="user.personTag"/>"/>
        	</div>
            ...
            <div class="choosed">
        		<div class="con">
        			...
        			<s:iterator value="#request.persontaglist" status="rowstatus">
                    <s:iterator value="#request.persontaglist[#rowstatus.index]" >
            ...
            <div class="addProf">
        		...
        		<input class="inputaddProfTag" type="button" value="添加个人标签" onclick="addProfTagPerson('inputaddPerson','divAddPersonTag');"/>
        		<span class="spanintro">个人标签可以有10个</span>
    		</div>	
