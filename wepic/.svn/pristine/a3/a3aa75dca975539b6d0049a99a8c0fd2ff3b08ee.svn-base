...
<title>wepic管理_个人中心_我的约拍_找模特_产品模特</title>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/back/personalCentr/myPart/js/releaseModel_cp.js"></script>
<!--公共js-->
  ...
  onkeyup="gbcount(this.form.name,this.form.total,this.form.used);"/>
        	...
        	<div class="divChooseCon">
            	<div class="shootBar">
                	...
                	<!--  
                		<a href="releaseModel_cp.html"><li class="active">产品模特</li></a>
                    	<a href="releaseModel_Tt.html"><li>T台模特</li></a>
                    	<a href="releaseModel_cm.html"><li>车模</li></a>
                    	<a href="releaseModel_hd.html"><li>活动/礼仪</li></a>
                ...
                <div class="divInfo">
                	<div class="productType">
                    	<div class="top">
                            ...
                            <!--  
                					<li class="active"><span>服饰鞋帽</span><i></i></li>
                    				<li><span>首饰珠宝</span><i></i></li>
 				                   	<li><span>箱包</span><i></i></li>
                			    	<li><span>化妆品</span><i></i></li>
              				      	<li><span>日用品</span><i></i></li>
     				               	<li><span>体育用品</span><i></i></li>
              				      	<li><span>办公用品</span><i></i></li>
     				               	<li><span>家居家具</span><i></i></li>
     				               	<li><span>汽车</span><i></i></li>
     				               	<li><span>电子电器</span><i></i></li>
                                     -->
                    ...
                    <!--第一列-->
                	<div class="shootOne">
                    	<div class="character">模特类型</div>
                        <div class="shootCon shootModelType">
                            <ul id="chooseModelType">
                                <li class="active"><span>不限</span><i></i></li>
                                <li><span>手模</span><i></i></li>
                                <li><span>腿模</span><i></i></li>
                                <li><span>脚模</span><i></i></li>
                                <li><span>内衣模特</span><i></i></li>
                                <li><span>服装模特</span><i></i></li>
                            </ul>
                        </div>
                	...
                	<div class="shootTwo">
                        ...
                        <div class="shootCon shootType">
                            <ul id="chooseShootType">
                                <li class="active"><span>不限</span><i></i></li>
                                <li><span>跟拍</span><i></i></li>
                                <li><span>寄拍</span><i></i></li>
                            </ul>
                        </div>
                        
                        <div class="character">拍摄团队需求</div>
                        <div class="shootCon shooTeam">
                            <ul id="chooseShootTeam">
                                <li class="active"><span>我方提供</span><i></i></li>
                                <li><span>模特提供</span><i></i></li>
                            </ul>
                        </div>
                	...
                	<div class="shootThree">
                        ...
                        <div class="time" id="choseTime"><input class="timeInputStr" id="txtBeginDate" name="workStartTime" type="text"/></div>
                        
                        
                    	<div class="character">交付日期</div>
                        <div class="time" id="choseTime2"><input class="timeInputStr" id="txtEndDate" name="workEndTime" type="text"/></div>
                        ...
                        <div class="divNum">
                        	...
                        	<input class="numinput" type="text" id="inputPersonNum" value="1" 
                	...
                	<div class="shootFour">
                        ...
                        <div class="shootCon shootValuation">
                            <ul id="chooseValuation">
                                <li class="active"><span>按件</span><i></i></li>
                        ...
                        <div class="divPrice">
                        	<input class="priceinput" type="text"
                                    ...
                                    onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'0')}else{this.value=this.value.replace(/\D/g,'')}"/>
                            <span class="pricesp" id="yuanAndPer">元/件</span>
                        </div>
                        ...
                        <div class="checkBox">
                        	...
                        	<div class="two" id="checkBoxModel">
                        		<input id="checkmodel" type="checkbox"/>
                            	<label for="checkmodel">报价已包含摄影费用</label>
                        	</div>
                        </div>
                ...
                <input  type="hidden" name="bidType" id="bidType" value="1"/>
                 ...
                 <input  type="hidden" name="unitpriceType" id="unitpriceType" value=""/>
                  <input  type="hidden" name="sumProductPhoto" id="sumProductPhoto" value="2"/>
            		<input class="finished" id="finished" type="button" onclick="verifyFormCp();" value="发布"/>
           		</div>
            </div>
