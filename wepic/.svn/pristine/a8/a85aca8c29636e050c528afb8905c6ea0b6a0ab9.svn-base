...
<title>wepic管理_个人中心_我的约拍_发布约拍_微电影拍摄</title>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/back/personalCentr/myPart/js/releaseShoot_wd.js"></script>
<!--公共js-->
...
<style>
#shootProduct .content .divChooseCon .divInfo .productNum .shootWayCon li{
	margin-right:5px;
	}
</style>
</head>
        	...
        	<div class="divChooseCon">
                ...
                <div class="divInfo">
                	<div class="productType">
                    	<div class="top">
                            ...
                            <div class="proType">
                            	...
                            	<!-- 
                					<li class="active"><span>品牌商业微电影</span><i></i></li>
                    				<li><span>影院放映微电影</span><i></i></li>
 				                   	<li><span>个人MV</span><i></i></li>
                                     -->
                	...
                	<div class="shootWay">
                        ...
                        <div class="character">拍摄产品演员需求</div>
                	...
                	<div class="shootTime">
                        ...
                        <div class="time" id="choseTime2"><input class="timeInputStr" id="txtEndDate" type="text" name="workEndTime" /></div>
                	...
                	<div class="productNum">
                        ...
                        <div class="shootWayCon shootWayjijia">
                            	<ul id="chooseShootjijia">
                					<li class="active"><span>按片长</span><i></i></li>
                	...
                	<div class="shootUnitPrice">
                        ...
                        <div class="divPrice">
                        	<input class="priceinput" type="text" name="unitpriceProduct" 
                                    ...
                                    onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'0')}else{this.value=this.value.replace(/\D/g,'')}"/>
                            <span class="pricesp" id="yuanAndPer">元/秒</span>
                        </div>
                        ...
                        <div class="checkBox">
                        	...
                        	<div class="two" id="checkBoxModel">
                            	...
                            	<label for="checkmodel">报价已包含演员费用</label>
                        	</div>
                            
                            <div class="two">
                        		<span>（此报价包含剧本创意、拍摄、后期）</span>
                        	</div>
                        </div>
                ...
                <input  type="hidden" name="bidType" id="bidType" value="1"/>
                 ...
                 <input  type="hidden" name="unitpriceType" id="unitpriceType" value=""/>
                  <input  type="hidden" name="sumProductPhoto" id="sumProductPhoto" value="3"/>
            		<input class="finished" id="finished" type="button" onclick="verifyFormWd();" value="发布"/>
           		</div>
            </div>
