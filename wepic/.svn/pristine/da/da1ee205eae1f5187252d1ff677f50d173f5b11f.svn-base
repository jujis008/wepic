...
<script type="text/javascript" src="${pageContext.request.contextPath}/back/personalCentr/user/js/accountHead.js"></script>
<!--公共css-->
...
function openNewwindow(){
     window.location.href="${pageContext.request.contextPath}/user!editeUserInfo.do?message=enpr";
...
<!-- 头部结束-->
     ...
     <!-- 导航 -->
  	<div id="assistantBar">
    	<div class="twoStage" id="divTwoStage">
        	<a href="${pageContext.request.contextPath}/user!getFistPageUserInfo.do"><div class='bar'><span>首页</span><i></i></div></a>
       ...
       <s:if test="#session.personOrCompany==2">
        <a href="${pageContext.request.contextPath}/user!baseUseInfo.do?message=enpr"><div id="enterpriseInfo" class="active tag">企业信息</div></a>
        	</s:if>
        	<s:else>
    ...
    <div id="divEnterpriseInfoFin">
        ...
        <div class="tableContent">
        	<table class="table">
            	<tr><td class="show">用户名</td><td class="val name">
            	<s:property value="#session.username"/>
            	</td></tr>
            	<tr><td class="show">企业名称</td><td class="val"><s:property value="user.nickName"/></td></tr>
            	<tr><td class="show">所属行业</td><td class="val"><s:property value="user.Industry"/></td><td class="show">成立时间</td><td class="val"><span><s:property value="user.companyBuildDate"/></span></td></tr>
            	<tr><td class="show">企业所在地</td><td class="val"><span><s:property value="user.companyAddr"/></span></td></tr>
            	<tr><td class="show">企业简介</td><td class="val"><span><s:property value="user.context"/></span></td></tr>
            </table>
        </div>
    </div>
    <!--内容-->
