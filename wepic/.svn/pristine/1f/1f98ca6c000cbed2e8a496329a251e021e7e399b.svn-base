...
<title>wepic管理员_用户_实名认证待审核_个人_待审核列表</title>
...
function checkpersondetail(id){
   var usercatid=$("#usercatId").val();
   location.href="configure!checkpersondetail.do?userId="+id+"&usercatId="+usercatid;
}
</script>
</head>
...
<!-- 头部结束-->
     ...
     <!-- 二级导航 -->
  	<div id="assistantBar">
    	<div class="twoStage" id="divTwoStage">
            ...
            <a href="configure!adminpersoncheck.do"><div class='bar active'><span>实名认证</span><i></i></div></a>
    ...
    <input type="hidden" value="<s:property value="usercatId"/>"  id="usercatId"/>
        <div class="div_job">
        ...
        <div class="ppointPaging">            
            <table class="tablePpointPaging">
                	<tr>
                    	...
                    	<td class="ppointPagingOne"><a href="configure!adminpersoncheckbytype.do?pageNo=1"></a></td>
                    	<s:if test="pager.pageCount ==1">
                        <td class="ppointPagingPre"><a href="configure!adminpersoncheckbytype.do?pageNo=1"></a></td>
                        </s:if>
                        <s:else>
                        <td class="ppointPagingPre"><a href="configure!adminpersoncheckbytype.do?pageNo=<s:property value='pager.prePageNo'/>"></a></td>
                        </s:else>
         <s:param name="first" value="1"/>  
          <s:param name="last" value="pager.pageCount"/>  
          <s:iterator>  
          <s:if test="pager.pageNo==current-1">
          <td class="ppointPagingN"><a href="configure!adminpersoncheckbytype.do?pageNo=<s:property />"><s:property /></a></td>
          </s:if>
          <s:else>
            <td class="ppointPagingN"><a href="configure!adminpersoncheckbytype.do?pageNo=<s:property />"><s:property /></a></td>
          </s:else>
           ...
           <s:if test="pager.pageCount ==1"> 
           <td class="ppointPagingNext"><a href="configure!adminpersoncheckbytype.do?pageNo=1"></a></td>
           </s:if>
           <s:else >
           <td class="ppointPagingNext"><a href="configure!adminpersoncheckbytype.do?pageNo=<s:property value='pager.nextPageNo'/>"></a></td>
           </s:else>
           <td class="ppointPagingLast"><a href="configure!adminpersoncheckbytype.do?pageNo=<s:property value='pager.pageCount'/>"></a></td>
            </s:bean>  
