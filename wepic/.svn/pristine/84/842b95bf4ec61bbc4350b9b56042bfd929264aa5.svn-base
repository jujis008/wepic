...
<link type="text/css" rel="stylesheet" href="back/configurationCentre/accountSecurity/css/authentGovernmentCheck.css" />
...
<!--                </s:if>-->
    ...
    <div class="container_body">
        ...
        <div class="auditNoPass_bg">
        	...
        	<div class="oth"><a href="<%=basePath %>configure!personvalidate.do">重新提交</a></div>
        </div>
