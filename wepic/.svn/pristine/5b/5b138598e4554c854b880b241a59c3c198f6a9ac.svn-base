...
<title>wepic管理_配置中心_账户安全_基本安全信息_修改邮箱_失败</title>
...
function modifyfail(){
location.href="configure!configuration.do";
}
</script>
</head>
...
<!-- 头部结束-->
    ...
    <div id="mainbar">
    	<div id="mainbarCenter">
            ...
            <div class="divTime">
            	<span class="loginTime">注册时间：</span><span> <s:date name="user.regTime" format="yyyy-MM-dd HH:mm:ss"/> </span>
            	<span class="preLogin">上次登录时间：</span><span><s:date name="loginHistory.loginTime" format="yyyy-MM-dd"/></span>
            </div>
        ...
        <div class="info_detail">
            ...
            <div class="info_password">
            	<div class="info_success">
                	<div class="failed_ico"></div>
                
                	<div class="success_right">
                    	<div class="succe">修改失败！</div>
                    	<div class="remin">可能能的验证码已超时，或者验证码错误</div>
                    </div>
                </div>
            	
                                
                <div class="password_three">
                    <input type="button" value="重新修改"  class="login_submit" onclick="modifyfail()"/>
                </div>
            </div>
        </div>
