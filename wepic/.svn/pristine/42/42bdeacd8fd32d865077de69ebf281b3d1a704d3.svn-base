...
<script type="text/javascript" src="${pageContext.request.contextPath}/public/js/jquery.js"></script>
 <script src="${pageContext.request.contextPath}/back/personalCentr/bid/js/releaseRecord.js" type="text/javascript"></script>
            	...
            	<div class="divUL" id="divListUL">
                	<ul>
                    	...
                    	<li>
                        	<div class="divLi">
                            	<div class="head">
                                	<a href="javascript:"><span class="name">
                                ...
                                <div class="num">
                                    ...
                                    <div class="divNumTime">
                            			<span >发布于</span>
                                    	<span class="time"> <s:property value="startTime"/></span>
                                        <a class="zero"><span>
                                ...
                                <div class="edit">
            						<div class="bj"></div>
               						<div class="ed">
                						<a href="javascript:" class="del" onclick="deleteLiFile(this);">删除</a>
