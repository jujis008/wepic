...
<script type="text/javascript" src="${pageContext.request.contextPath}/back/personalCentr/bid/js/recruitTalentsform.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/back/personalCentr/bid/js/recruitTalents.js"></script>
        	...
        	<div class="center">
                ...
                <table>
                	<tr>
                        ...
                        <td class="tdtitleinput">
                        <input class="titleinput" type="text" name="name" id="namebidFor"/></td>
                        <td><span class="left">招募
                        <input type="hidden" name="bidtag" id="bidtag" />
                        </span></td>
                       <td style="z-index: 1000;">
                        	<div class="divdropDown">
                    			<div onclick="showBelow('divdropDownInviteType')" class="dropDownBox">
                    				<span id="divdropDownViewInviteType">选择招募人才</span>
                        			<div class="dropDownBoxR"><i></i></div>
                    			</div>
                    
                    			<div id="divdropDownInviteType">
                    				<div class="model">
                                    	<div class="char"><span class="charp">招募模特<i></i></span></div>
                                        <div class="modelt">
                                        	<span class="one">平面影视模特<i></i></span>
                                            <span class="two">产品形象模特<i></i></span>
                                        </div>
                                        <div class="modelt">
                                        	<span class="one">礼仪模特<i></i></span>
                                            <span class="two">车模<i></i></span>
                                        </div>
                                        <div class="modelt">
                                        	<span class="one">服装模特<i></i></span>
                                            <span class="two">表演模特<i></i></span>
                                        </div>
                                        <div class="modelt">
                                        	<span class="one">人体模特<i></i></span>
                                            <span class="two">内衣模特<i></i></span>
                                        </div>
                                        <div class="modelt">
                                        	<span class="one">少儿模特<i></i></span>
                                            <span class="two">中老年模特<i></i></span>
                                        </div>
                                        <div class="modelt">
                                        	<span class="onez">脸模<i></i></span>
                                        	<span class="onez">眼模<i></i></span>
                                        	<span class="onez">手模<i></i></span>
                                        	<span class="onez">耳模<i></i></span>
                                        </div>
                                         <div class="modelt">
                                        	<span class="onez">腿模<i></i></span>
                                        	<span class="onez">脚模<i></i></span>
                                        	<span class="onez">牙模<i></i></span>
                                        	<span class="onez">鼻模<i></i></span>
                                        </div>
                                    </div>
                                    <div class="poho">
                                    	<div class="char"><span class="charp">招募摄影师<i></i></span></div>
                                        <div class="modelt">
                                        	<span class="one">时装摄影师<i></i></span>
                                            <span class="two">广告摄影师<i></i></span>
                                        </div>
                                        <div class="modelt">
                                        	<span class="one">人像摄影师<i></i></span>
                                            <span class="two">产品摄影师<i></i></span>
                                        </div>
                                        <div class="modelt">
                                        	<span class="one">建筑摄影师<i></i></span>
                                            <span class="two">场景摄影师<i></i></span>
                                        </div>
                                        <div class="modelt">
                                        	<span class="one">新闻摄影师<i></i></span>
                                            <span class="two">时尚摄影师<i></i></span>
                                        </div>
                                        <div class="modelt">
                                        	<span class="one">广告片摄影师<i></i></span>
                                            <span class="two">摄像师<i></i></span>
                                        </div>
                                    </div>
                    			</div>
                  			</div>
                ...
                <div class="divPartTime divPartTimezm">
                    ...
                    <div id="mtsj">
                    	 <span class="spantimemt">每天约</span>
                         <input type="text" class="timeInputMin" value="8" />
                         <span class="spantime">小时</span>
                    </div>
                    ...
                    <div class="divPartEnv">
                    	<table>
                        	<tr>
                                ...
                                <td class="recruitNumtd"><span>招募人数</span></td>
                              <td><input type="text" class="recruitNum" id="recruitNum" name="recruitNum"/></td>
                            </tr>
                        </table>
                        	...
                        	<td class="dropDownBoxBidTypetd">
                            	<div class="divdropDown">
			                    		<div class="dropDownBox" id="dropDownBoxBidType" onclick="showBelow('divdropDownBidType')">
            			        			<span id="divdropDownViewBidType">公开招标</span>
                        					<div class="dropDownBoxR"><i></i></div>
			                    		</div>
                ...
                <div class="submit">
               		...
               		<input type="hidden" value="" name="needModelOrPhoto" id="needModelOrPhoto" />
