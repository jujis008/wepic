...
function cancel(){
location.href="<%=basePath %>account!cashoverview.do";
}
function next(){
location.href="<%=basePath %>account!confirmtransfer.do";
}
</script>
</head>
...
<!-- 头部结束-->
    ...
    <div class="topUp_chooseBlank">
    	...
    	<table class="table_transfer">
            ...
            <tr>
            	<td class="td_two">
                	<span>1、如果您已经到银行柜台或网上银行办理过转账手续，请点击下一步</span>
                </td>
            </tr>
            <tr>
            	<td class="td_two">
                	<div class="twodiv">2、如果您尚未到银行柜台或网上银行办理转账手续，请记录以下内容办理转账手续再继续操作。</div>
                </td>
            </tr>
        </table>
    	
        <table class="table_transferTwo">
        	<tr>
            	<td class="td_one" colspan="2">我们的转账账户为：</td>
            </tr>
            ...
            <tr>
                ...
                <td class="td_two">
                	<span>2132131213212132121</span>
                </td>
            </tr>
            <tr>
            	<td class="td_one" colspan="2">
                	<span>转账成功后请拨打我们的客服电话：</span>
                    <span class="phone">400-809-9060</span>
                </td>
            </tr>
        </table>
        ...
        <div class="topUp_submit">
        	<div class="submit_next">
            	<input class="applicationDeposit" type="button" value="取消充值"  onclick="cancel()"/>
        		<input class="recharge" type="button" value="下一步"  onclick="next()"/>
        	</div>
        </div>
    </div>
