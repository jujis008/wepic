...
<title>wepic管理_配置中心_账户安全_实名认证_其他填写信息</title>
...
<link type="text/css" rel="stylesheet" href="<%=basePath %>back/configurationCentre/accountSecurity/css/authentOther.css" />

<script type="text/javascript" src="<%=basePath %>back/configurationCentre/accountSecurity/js/authentOther.js"></script>
...
function linkgoverment(type){
    ...
    function othersubmit(){
     var form = document.getElementById("formEnterprise2");
     var validateres=submitVerification2();
     alert(validateres);
	 ...
	 form.action="configure!othervalidateing.do?certificatePic="+yingyezhizhao+"&licenseagreement="+shenqinggonghan+"&idCardFrontPic="+zhengjianzhao;  
	 form.submit();  
     }
    }
</script>
...
<!--                </s:if>-->
    ...
    <!--内容-->
    <form id="formEnterprise2" method="post">
    ...
    <div class="container_body">
        	...
        	<table>
            	<tr class="tr_enterprise">
                	...
                	<td class="td_two">
						...
						<input type="radio" name="enterpriceType" value="4" id="radioOther" class="rightI"  checked="checked" onclick="linkgoverment(this.value)"/>
                ...
                <tr class="tr_enterpriseInfor">
                	<td class="td_one"><label>*</label><span>组织名称</span></td>
                ...
                <tr class="tr_enterpriseInfor">
                	<td class="td_one"><label>*</label><span>组织邮箱</span></td>
                ...
                <tr class="tr_enterpriseInfor">
                	<td class="td_one"><label>*</label><span>组织地址</span></td>
                    <td class="td_two" colspan="3"><input id="enterpriseAddress" name="companyAddr" class="input_textTop" type="text" onblur="checkNull('enterpriseAddress','enterpriseAddressRemind');"/></td>
                </tr>
                <tr class="tr_enterpriseInforRemind">
                	<td class="td_one"></td>
                ...
                <div class="div_chooseFileBut">
                	<div class="but_preview">
                        <input type="button" value="上传执照"  class="upload_pho" id="upgovermentInfo" onclick="uploadPhotographImg(this,'imgRegistryForm','uploadSuccessIcoo','uploadRemind1');"/>
        ...
        <div class="submit">
               <div class="inp">
					...
					<input class="finished" type="button" value="提交" onclick="othersubmit()"/>
               </div>
        </div>
        </form>
    </div>
