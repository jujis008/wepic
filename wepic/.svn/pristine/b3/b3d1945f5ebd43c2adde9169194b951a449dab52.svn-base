...
<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/administrator/production/css/picWorkSingleCheck.css" />
        	...
        	<div class="phoStroyDetailLeft"  id="phoStroyDetailLeft">
                ...
                <div class="divDescribe">
                	<div class="edit" id="editzpgs">
                        ...
                        <div class="bjc">
                            <div class="right">
                                <a href="publish!downloadPic.do?id=<s:property value="publish.id"/>" class="dowload">
                                    <div class="backimg"></div>
                                    <p>下载原图</p>
                                </a>
                                <a href="publish!adminDeletePhoto.do?id=<s:property value="publish.id"/>'" class="delete">
                                    <div class="backimg"></div>
                                    <p>删除作品</p>
                                </a>
                            </div>
                      ...
                      <div class="typeone">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td4">
                                        <s:property value="publish.publishTime"/>
                                        </td>
                                    </tr>
                                </table>
                        </div>
                        ...
                        <div class="passedOperation" id="passedOperation">
                            <div class="opeation">
                                <input class="pass" type="button" id="" value="编辑属性"/>
                                <input class="pass" type="button" id="" value="下架"    onclick='javascript:openReson(<s:property value="publish.id"/>)'/>
       ...
       <div id="noPassReason" class="noPassReason" style="display: none; position: absolute; z-index: 10000; top: 108px; left: 487.5px;">
        ...
        <div class="editNoPass">      
            ...
            <div id="opeationPass" class="opeation">
                ...
                <input type="submit"  value="保存" class="noPass">
