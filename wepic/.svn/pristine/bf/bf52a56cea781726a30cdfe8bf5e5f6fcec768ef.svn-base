...
$(function(){
        ...
        $.ajax({
  	      type:"Post",
  		  url: "userstory_storychecksucprenext.do?specialId="+id,
  		  data:"",		
  		  success : function(data) {
  	  	  ...
  	  	  cxt+="<div class='pre'><a href='story!adminchecksucsearch.do?storyId="+pre+"'><i></i><span >上一篇</span></a></div><div class='next'>"+
               "<a href='story!adminchecksucsearch.do?storyId="+next+"'><span>下一篇</span><i></i></a></div>";
           $(".preNext").html(cxt);  	  	  
  		  }
    	});
        });
        
        function adminsoldout(id){
           location.href="story!adminsinglesoldout.do?storyId="+id;        
        }
</script>
</head>
                	...
                	<div class="edit" id="editzpgs">
                    	...
                    	<div class="bjc">
                            ...
                            <div class="right">
                            	...
                            	<a href="story!adminsinglesoldout.do?storyId=<s:property value='story.id'/>" class="delete">
                            		<div class="backimg"></div>
									<p>下架</p>
                           		</a>
                            </div>
                    ...
                    <div id="storyConScrollTop">
                        ...
                        <div class="passedOperation" id="passedOperation">
                            <div class="opeation">
                                ...
                                <input class="pass" type="button" id="" value="下架" onclick="adminsoldout(<s:property value='story.id'/>)" />
