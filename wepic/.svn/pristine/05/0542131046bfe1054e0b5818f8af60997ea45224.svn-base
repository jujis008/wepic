                            ...
                            <table class="tablePpointPaging">
                                    <tr>
                                        ...
                                        <s:bean name="org.apache.struts2.util.Counter" id="counter">  
                                           ...
                                           <s:iterator> 
                                          <td class="ppointPagingN"><a href="${pageContext.request.contextPath}/responseInvitednew!lisetSetPerople.do?id=<s:property value="bidId"/>&nowPage=<s:property/>"><s:property/></a></td>
                                         </s:iterator>  
                                        </s:bean>  
