...
<title>wepic管理员_用户_实名认证待审核_政府_单个审核</title>
...
$(function(){
        ...
        $.ajax({
  	      type:"Post",
  		  url: "configurajson_govermentprenext.do?userenterprisetype=1&userpersonOrCompany=2&userifIdentityTrue=1",
  		  data:"",		
        ...
        <div class="div_container">
        	<div class="left_Con">
            	<div class="businessLicense_img">
                	<img src="<s:property value="user.govermentenrollment"/>" />
                	
                    <div class="business">
                    	<div class="bg"></div>
                        <div class="bgcon">政府信息登记表显示位置</div>
                    </div>
                </div>
        	...
        	<div class="right_Con">
                ...
                <div class="autonyMaudit" id="autonyMaudit">
                    ...
                    <div class="opeation">
                        ...
                        <input class="noPass" type="button" value="通过" onclick="passOpertion(this,'autonyMaudit','showAll')"/>
                    </div>
                </div>
                <!--操作是否通过-->
