...
window.onload = function(){
	...
	achieveBelow("divSelectHighestDegreeValue","selectHighestDegreeValue")					/*获取下拉框值并隐藏	专辑*/
	document.getElementById("storyform").reset();

	}
function mysmt(id){
 verifyForm();
 storyform.action="story!savestory.do?flag="+id;  
 storyform.submit();   
}
 $(function(){
	  $.ajax({
	      type:"Post",
		  url: "projectCat_typecatOfStory.do",
		  data:"",		
        	...
        	<div class="head">
            	<div class="left">
                	<div class="img" id="divChangeHead">
                    	...
                    	<img src="" onload="javascript:DrawImage(this,285,175)"/>
...
<!--                    	<div>作品编号：<span>42234324242344</span></div>-->
                ...
                <div class="right">
                	<div class="title">
                    	<span>故事标题</span>
                        <input class="texttitle" type="text" name="title" id="texttitleinp" onblur="promptInfo('texttitleinp','titleprompt',40);"/>
                    	<span>所属专辑</span>
                    ...
                    <div class="editSelect" id="divHighestDegree" >
                    	<div class="viewBelow" onclick="showBelow('divSelectHighestDegreeValue')" id="viewBelowHighestDegree">
                        	<div id="selectHighestDegreeValue"><input type="hidden" name="special" value="0"/>默认专辑</div>
                    ...
                    <div class="storyDe">
                        ...
                        <textarea id="textareastorytt" name="storydescription" onblur="promptInfo('textareastorytt','textareaStory',400);"></textarea>
                    </div>
...
<!--                        </div>-->
        ...
        <div class="submit">
               		...
               		<input class="inputfb" type="button" value="发布作品" onclick="mysmt(1)"/>
               		
                <div class="inp">
               		<input class="inputup" type="button" value="取消" />
					<!-- <input class="finished" type="button" value="保存" onclick="verifyForm();"> -->
					<input class="finished" type="button" value="保存" onclick="mysmt(0)"/>
               </div>
        </div>
    </div>
    </form>
