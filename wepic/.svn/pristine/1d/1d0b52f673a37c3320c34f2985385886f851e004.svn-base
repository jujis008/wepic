...
<title>wepic管理_个人中心_我的约拍_找模特_外拍</title>
                            ...
                            <div class="proType">
                            	...
                            	<!-- 
                			    	...
                			    	<li><span>产品宣传片</span><i></i></li>
                			    	 onclick="addCustom('addCustomInput','chooseProductType');"
                			    	 -->
                ...
                <input  type="hidden" name="bidType" id="bidType" value="1"/>
                 ...
                 <input  type="hidden" name="unitpriceType" id="unitpriceType" value=""/>
                  <input  type="hidden" name="sumProductPhoto" id="sumProductPhoto" value="5"/>
            		...
            		<input class="finished" id="finished" type="button" onclick="verifyFormWp();" value="发布"/>
           		</div>
            </div>
