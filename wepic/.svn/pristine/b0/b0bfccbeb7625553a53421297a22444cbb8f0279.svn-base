...
<title>wepic管理_配置中心_账户安全_实名认证_其他_审核中</title>
    ...
    <div class="container_body">
        ...
        <table class="table_top">
        	<tr class="th_top">
            	...
            	<th class="approveType"><span>认证类型：</span><span>其他</span></th>
            </tr>
            <tr>
            	<td class="td_one"><span>组织名称</span></td>
                ...
                <td class="td_editr"></td>
            </tr>
            
            <tr>
            	<td class="td_one"><span>组织邮箱</span></td>
            ...
            <tr>
                ...
                <td class="td_edit">
                	<a onclick="editObjcompanyAddr(this,'inputRelationEntAddress');">修改</a>
                </td>
            </tr>
            
            
            <tr class="tr_license">
            	<td class="td_one"><span>组织机构代码描件</span></td>
                <td class="td_two">
                	<div class="img_preview">
                        ...
                        <i></i>
                        <div class="character">您的组织机构照将显示在此处</div>
                    </div>
                </td>
        ...
        <table class="table_main">
            ...
            <tr>
                ...
                <td class="td_five" rowspan="6">
                	<div class="img_preview">
                    	<table><tr><td id="imgPpreviewPhotograph">
                    	<img src="<s:property value="user.idCardFrontPic"/>" onload="javascript:DrawImage(this,200,200)" onclick="showImg(this.src);"/>
                    	</td></tr></table>
                        <i></i>
