...
<title>wepic管理员_作品_摄影故事_已审核通过作品列表</title>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/administrator/production/js/picWorkPassedList.js"></script>

<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/administrator/production/css/picWorkPassedList.css" />
</head>
...
<!-- 头部结束-->
        ...
        <div id="divThreeStage">
            ...
            <div class="threeStage">
               <a href="publish!adminCheckPhotoPic.do"><div class='bar'><span>待审核作品</span><i></i></div></a>
                ...
                <a href="publish!adminPassPhotoPic.do"><div class='bar active'><span>作品列表</span><i></i></div></a>
                    ...
                    <li>
                        ...
                        <!--默认显示-->
                            ...
                            <div class="nowtop">
                        		<div class="bj"></div>
                        		<div class="bjc">
                                	 <div class="viewBjCon" title="查看详情" onclick="window.location='${pageContext.request.contextPath}/publish!adminfindPassDetail.do?id=<s:property value="id"/>'">
                        			<div class="picName"><s:property value="name"/></div>
                                    
                                        <div class="divNum"><span>作品编号：</span><span><span><s:property value="picNumber"/></span></div>
                                    ...
                                    <div class="picEdit">
                                    	<a class="xj" title="作品下架" href='javascript:openReson(<s:property value="id"/>)'></a>
                                        <a class="down" title="下载作品" href="publish!downloadPic.do?id=<s:property value="id"/>"></a>
                                        <a href="javascript:void(0)" target="_blank" class="edit" title="编辑作品"></a>
                                        <a href="#" class="view" title="查看作品" onclick="window.location='${pageContext.request.contextPath}/publish!adminfindPassDetail.do?id=<s:property value="id"/>'"></a>
                                    </div>
                                </div>
                        	</div>
                            <!--鼠标滑过显示-->
    ...
    <!--foot 结束-->
    <div id="noPassReason" class="noPassReason" style="display: none; position: absolute; z-index: 10000; top: 108px; left: 487.5px;">
        <div class="top">不通过下架</div>
         <form id="adminPassPhoto" method="post" action="publish!adminUndercarriage.do">
        <div class="editNoPass">      
            <table id="tablePass">
                <tbody><tr>
                    <td class="td1"><input type="checkbox" value="1" name="count" id="checkzjwt">
                    <input type="hidden" id="noPassId" name="id" value="313">
                    </td>
                    <td><label for="checkzjwt">您上传的证件不清晰</label></td>
                </tr>
            
                <tr>
                    <td class="td1"><input type="checkbox" value="2" name="count" id="checkzjgd"></td>
                    <td><label for="checkzjgd">证件照片有改动</label></td>
                </tr>
                
                <tr>
                    <td class="td1"><input type="checkbox" value="3" name="count" id="checksfz"></td>
                    <td><label for="checksfz">您提交的身份信息不正确</label></td>
                </tr>
                
                <tr class="other">
                    <td valign="top" class="td1"><input type="checkbox" name="count" id="checkqit"></td>
                    <td class="otherCon"><label for="checkqit">其他</label><textarea name="count"></textarea></td>
                </tr>
            </tbody></table>
            <div id="opeationPass" class="opeation">
                <input type="button" onclick="resetInfo('noPassReason')" value="取消" class="pass">
                <input type="submit" onclick="saveInfo('noPassReason')" value="保存" class="noPass">
