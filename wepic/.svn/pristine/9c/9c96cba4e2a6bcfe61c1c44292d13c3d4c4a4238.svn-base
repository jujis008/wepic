...
<title>wepic管理_个人中心_我的约拍_找模特_车模</title>
        	...
        	<div class="divChooseCon">
            	<div class="shootBar">
                	...
                	<s:if test="id==bidCat.id">
                    	...
                    	<a href="releaseModel_cm.html"><li class="active">车模</li></a>
                	...
                	<div class="productType">
                    	<div class="top">
                            ...
                            <div class="proType">
                            	...
                            	<!-- 
                					<li class="active"><span>展览会</span><i></i></li>
                    				<li><span>发布会</span><i></i></li>
 				                   	<li><span>产品拍摄</span><i></i></li>
                                     -->
                	...
                	<div class="shootTwo">
                        ...
                        <div class="shootCon shootType">
                            <ul id="chooseShootType">
                                <li class="active"><span>站台</span><i></i></li>
                                <li><span>拍摄</span><i></i></li>
                            </ul>
                        </div>-->
                ...
                <input  type="hidden" name="bidType" id="bidType" value="1"/>
                 ...
                 <input  type="hidden" name="unitpriceType" id="unitpriceType" value=""/>
                  <input  type="hidden" name="sumProductPhoto" id="sumProductPhoto" value="5"/>
            		<input class="finished" id="finished" type="button" onclick="verifyFormCm();" value="发布"/>
           		</div>
            </div>
