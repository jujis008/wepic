...
<title>wepic管理_个人中心_我的约拍_发布约拍_产品拍摄</title>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/back/personalCentr/myPart/js/releaseShoot_cp.js"></script>
...
onkeydown="gbcount(this.form.name,this.form.total,this.form.used);" 
  onkeyup="gbcount(this.form.name,this.form.total,this.form.used);"
	  onblur="gbcount(this.form.name,this.form.total,this.form.used);"
  value="<s:property value="bidCat.bidName"/>"
  />
        	...
        	<div class="divChooseCon">
            	<div class="shootBar">
                	...
                	<s:if test="id==bidCat.id">
                		...
                		<!-- <a href="releaseShoot_pm.html"><li>平面广告拍摄</li></a>
                    	<a href="releaseShoot_hd.html"><li>活动现场拍摄</li></a>
                    	<a href="releaseShoot_gg.html"><li>广告片/宣传片拍摄</li></a>
                    	<a href="releaseShoot_wd.html"><li>微电影</li></a>
                    	<a href="releaseShoot_xz.html"><li>个人写真</li></a>
                    	 -->
                ...
                <div class="divInfo">
                    	...
                    	<div class="top">
                            ...
                            <s:iterator value="bidcats" status="index">
                				...
                				<!-- 
 				                   	...
 				                   	<li><span>食品菜肴</span><i></i></li>
                			    	<li><span>办公用品</span><i></i></li>
              				      	<li><span>电子电器</span><i></i></li>
     				               	<li><span>家居家具</span><i></i></li>
              				      	<li><span>办公用品</span><i></i></li>
     				               	<li><span>医药医疗</span><i></i></li>
     				               	<li><span>体育用品</span><i></i></li>
              				      	<li><span>汽车</span><i></i></li>
     				               	<li><span>电子电器</span><i></i></li>
     				               	<li><span>建筑装饰</span><i></i></li>
              				      	<li><span>机械设备</span><i></i></li>
     				               	<li><span>工业材料</span><i></i></li>
                	...
                	<div class="shootWay">
                        ...
                        <div class="shootWayCon">
                            	<ul id="chooseShootWay">
                					<li class="active"><span>不限
                					<input type="radio" name="pohotype" style="display: none" />
                					</span><i></i></li>
                    				<li><span>跟拍</span><i></i>
                    				<input type="radio" name="pohotype" style="display: none" />
                    				</li>
                        ...
                        <div class="character">拍摄产品模特需求</div>
                        <div class="shootWayCon shootWayConmodel">
                            	<ul id="chooseShootModel">
                					<li class="active"><span>不需要</span><i></i></li>
                    				<li><span>我方提供</span><i></i></li>
 				                   	<li><span>摄影师提供</span><i></i></li>
                				</ul>
                        </div>
                    </div><!-- ssss -->
                	<div class="shootTime">
                	...
                	<div class="productNum">
                        ...
                        <div class="divNum">
                        	...
                        	<input class="numinput" name="sumProdct" type="text" id="inputproductNum" value="1" 
                	...
                	<div class="shootUnitPrice">
                        ...
                        <div class="checkBox">
                        	...
                        	<div class="two" id="checkBoxModel">
                            	...
                            	<label for="checkmodel">报价已包含模特费用</label>
                        	</div>
                        </div>
