...
<title>wepic管理_配置中心_账户安全_实名认证_企业_审核中</title>
<script type="text/javascript" src="<%=basePath %>public/js/imgsf.js"></script>

<link type="text/css" rel="stylesheet" href="<%=basePath %>back/configurationCentre/accountSecurity/css//authentPersonalCheck.css" />
...
<script type="text/javascript" src="<%=basePath %>back/configurationCentre/accountSecurity/js/authentPersonalCheck.js"></script>
</head>
...
<!--                </s:if>-->
    ...
    <div class="container_body">
        ...
        <table class="table_main">
        	<tr class="th_top">
            	<th colspan="2"><span>个人认证信息</span></th>
            </tr>
            <tr>
            	<td class="td_one"><span>真实姓名</span></td>
                <td class="td_two"><span><s:property value="user.realName"/></span></td>
                <td class="td_three"></td>
                <td class="td_four">身份证照</td>
                <td class="td_five" rowspan="6">
                	<div class="img_preview">
                    	<table><tr><td id="imgPpreviewPhotograph">
                    	
                    	<img id="idCardBackPic" src="<s:property value="user.idCardBackPic"/>" onload="javascript:DrawImage(this,200,200)" onclick="showImg(this.src);"/></td></tr></table>
                        <i></i>
            ...
            <tr>
            	<td class="td_one"><span>身份证号</span></td>
                <td class="td_two"><span><s:property value="user.idCardNo"/></span></td>
                <td class="td_three"></td>
                <td class="td_four"></td>
            </tr>
            ...
            <tr>
                ...
                <td class="td_two"><span id="beforemobile"><s:property value="user.mobile"/></span></td>
