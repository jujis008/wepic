...
public class ImgWaterMark {
    ...
    public static void main(String[] args) {  
        String srcImgPath = "d:/images/abc.jpg";  
        String logoText = "测试文字水印";  
        //String targerPath = "d:/images/sec.jpg";  
  
        String targerPath2 = "d:/images/def.jpg";  
  
        // 给图片添加水印  
  //      ImageMarkLogoByText.markByText(logoText, srcImgPath, targerPath);  
  
        // 给图片添加水印,水印旋转-45  
        ImgWaterMark.markByText(logoText, srcImgPath, targerPath2, -45);  
    }  
