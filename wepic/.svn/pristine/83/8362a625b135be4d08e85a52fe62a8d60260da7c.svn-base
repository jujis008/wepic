...
<title>wepic个人中心 用户基本资料 企业版</title>
<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/back/personalCentr/user/css/accountEnterpriseInfo.css" />

<script type="text/javascript" src="${pageContext.request.contextPath}/public/js/jquery.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/back/personalCentr/user/js/accountEnterpriseInfo.js"></script>
<!--公共js-->
...
function subForm(){
	var yea=$("#selectEstablishYearValue").html();
	var moth=$("#selectEstablishMonthValue").html();
	var date=$.trim(yea)+"-"+$.trim(moth);
	$("#companyBuildDateId").val(date);
	$("#companyAddrid").val($.trim($("#comP").val())+" "+$.trim($("#comCity").val())+" "+$.trim($("#comxian").val()));
	$("#formEnterpriseInfo").submit();
}
...
<!-- 头部结束-->
    ...
    <!-- 导航 -->
  	<div id="assistantBar">
    	<div class="twoStage" id="divTwoStage">
            ...
            <a href="${pageContext.request.contextPath}/back/personalCentr/user/accountEnterpriseInfo.jsp">
            </s:if>
            <s:else>
            <s:if test="#session.role!='model'">
            <a href="${pageContext.request.contextPath}/back/personalCentr/user/accountPersonInfo.jsp">
            </s:if>
            
            <s:else>
            <a href="${pageContext.request.contextPath}/back/personalCentr/user/accountPersonInfoModel.jsp">
            </s:else>
    ...
    <!--内容-->
    <div id="divtEnterpriseInfo">
    <form  id="formEnterpriseInfo" action="user!updetaEnterPiserBaseInfo.do" method="post">
    	<div class="title">
        	<h2>企业信息</h2>
        </div>
        ...
        <div class="content">
            ...
            <div class="enterpriseName">
        		<span class="left">公司简称</span>
            	<input type="text"  class="inputEnterpriseName inputT" name="nickName" value="<s:property value="#session.nickName"/>"/>
            </div>
            <div class="trade">
        		<span class="left">所属行业</span>
            	<input type="text"  class="inputTrade inputT" name="industry" value=""/>
                <span class="establishTime">成立时间</span>
                <input type="hidden" id="companyBuildDateId" name="companyBuildDate" value="<s:property value="user.industry"/>"/>
                <div class="editSelect" id="divSelectEstablishYear">
                    <div  class="viewBelow" onclick="showBelow('divSelectEstablishYearValue')">
                        <div id="selectEstablishYearValue"> 
                    ...
                    <div class="belowValue" id="divSelectEstablishYearValue" style="display:none;">
 					</div>
            	</div>
                
                
                <div class="editSelect" id="divSelectEstablishMonth">
                    <div  class="viewBelow" onclick="showBelow('divSelectEstablishMonthValue')">
                        <div id="selectEstablishMonthValue">
                    ...
                    <div  class="belowValue" id="divSelectEstablishMonthValue" style="display:none;">
 					</div>
            	</div>
            </div>
            
            <div class="address" >
        		<span class="left">企业所在地</span>
        		 <input name="companyAddr" type="hidden" value="" id="companyAddrid" />
                <div class="adr" id="citySelectTag">
                    <dl>
                        <dt>
                            <span class="arr"></span>
                            <div class="xl"><i></i></div> 
                            <input name="Area_province" type="hidden" value=""  id="comP"/>
                        </dt><dd></dd>
                    </dl>
                    <dl>
                        <dt>
                        	<span class="arr"></span>
                            <div class="xl"><i></i></div> 
                        	<input name="Area_city" type="hidden" value="" id="comCity" />
                        </dt><dd></dd>
                    </dl>
                    <dl>
                        <dt>
                           <span class="arr"></span>
                           <div class="xl"><i></i></div> 
                           <input name="Area_District" type="hidden" value=""  id="comxian"/>
                        </dt><dd></dd>
                    </dl>
                <script type="text/javascript">
                        new locatArea('<s:property value="#detalfor.sheng" escape="false"/>','<s:property value="#detalfor.city" escape="false"/>','<s:property value="#detalfor.xian" escape="false"/>',document.getElementById('citySelectTag'));
                       // new locatArea("内蒙古自治区","呼和浩特市","土默特左旗",document.getElementById('citySelectTag2'));
                </script>
                </div>
            ...
            <div class="abstract">
        		<span class="leftabstract">企业简介</span>
                <textarea name="context">
                <s:property value="user.context"/>
