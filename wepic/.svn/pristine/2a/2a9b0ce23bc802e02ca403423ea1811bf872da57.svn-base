...
<title>wepic管理员_用户_实名认证待审核_政府_审核未通过</title>
...
$(function(){
        ...
        $.ajax({
  	      type:"Post",
  		  url: "configurajson_govermentprenext.do?userenterprisetype=1&userpersonOrCompany=2&userifIdentityTrue=3",
  		  data:"",		
    ...
    <div class="container_body">
        <div class="div_job">
            <ul class="ul_job">
            	...
            	<li onclick="governmentnopass()" class="active">政府机构</li>
