...
<title>wepic管理_配置中心_账户安全_实名认证_媒体_审核成功</title>
    ...
    <div class="container_body">
        ...
        <table class="table_top">
        	<tr class="th_top">
            	...
            	<th class="approveType"><span>认证类型：</span><span>媒体</span></th>
            </tr>
            
            
            
            <tr class="tr_license">
            	<td class="td_one"><span>媒体信息登记表</span></td>
                <td class="td_two">
                	<div class="img_preview">
                    	<table><tr><td id="imgPpreviewPhotograph">
                    	<img src="<s:property value="user.mediaenrollment"/>" alt="" onload="javascript:DrawImage(this,200,200)" onclick="showImg(this.src);"/>
                    	</td></tr></table>
                        <i></i>
                        <div class="character">您的媒体信息登记表将显示在此处</div>
                    </div>
                </td>
                <td class="td_three"><span>企业认证申请公函</span></td>
                <td class="td_four">
                	<div class="img_preview">
                    	<table><tr><td id="imgPpreviewPhotograph"><!--<img src="../../../pubimg/pic/1.png" onload="javascript:DrawImage(this,200,200)" onclick="showImg(this);"/>-->
