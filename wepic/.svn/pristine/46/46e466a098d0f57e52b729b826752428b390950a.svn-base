...
<title>wepic管理-个人中心-我的约拍-发布-商业拍摄-宣传片+广告片</title>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/back/personalCentr/bid/js/releaseComShoot_ggrwform.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/back/personalCentr/bid/js/releaseComShoot_ggrw.js"></script>
        ...
        <form action="${pageContext.request.contextPath}/bid!addBid.do" method="post" id="bidaddForm">
        	...
        	<div class="center">
               ...
               <div class="divPartNum">
                	<span class="left">宣传片长</span>
                	<input type="text" class="inputPartNum" id="sumProductPhoto" name="sumProductPhoto"/>
                    <span class="spanPartNumz">秒</span>
                    <span class="spanPartNum">摄影师需要提供的作品数量</span>
                </div>
                
                
                <div class="divPartOffer divPartOfferxcgg">
                	<table class="tablePartOffer">
                    	<tbody><tr>
                        	<td class="td1"><span class="">邀约报价</span></td>
                            
                            <td class="td4"><input type="text" name="totalMoney" id="totalMoney"/></td>
                            <td class="td5 td5xcgg"><span>元</span></td>
                            <td class="td6"><input type="checkbox" value="1" id="checkkbj" name="checkkbj"/><label for="checkkbj">应约者可报价</label></td>
