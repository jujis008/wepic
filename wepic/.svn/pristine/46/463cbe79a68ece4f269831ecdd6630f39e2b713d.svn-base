...
<link type="text/css" rel="stylesheet" href="<%=basePath %>back/personalCentr/myworklib/css/phoStoryUnpublished.css" />
<script type="text/javascript" src="<%=basePath %>public/js/imgsf.js"></script>
<script type="text/javascript" src="<%=basePath %>public/js/jquery.js"></script>
<script type="text/javascript" src="<%=basePath %>back/personalCentr/myworklib/js/phoStoryUnpublished.js"></script>
<!--公共js-->
     ...
     function getImgSUnm(id,storystatu){
        ...
        $.ajax({
  		  ...
  		  success : function(data) {
  	  	  ...
  	  	  cxt+="<div class='pre'><a href='story!searchStoryunpublish.do?id="+pre+"'><i></i><span >上一篇</span></a></div><div class='next'>"+
               "<a href='story!searchStoryunpublish.do?id="+next+"'><span>下一篇</span><i></i></a></div>";
           $(".preNext").html(cxt);  	  	  
  		  }
    	});
        });
...
{
    location.href="story!delstory.do?storyId="+id;
}
}
   		...
   		<div class="head">
            <table>
            	<tr>
                	<td class="td1">
                    	<div class="divdropDown">
                    		<div class="dropDownBox" id="dropDownBoxPartType" onclick="showBelow('divdropDownPartType')">
                    			<span id="divdropDownViewPartType"><s:property value="#specialCat.name"/></span>
                    		...
                    		<div class="dropDownBoxValue" id="divdropDownPartType">
                 			 ...
                 			 <form action="searchPublishPic!searchunpublishstoryByfrom.do" method="post" id="unpublishstory">
                    ...
                    <td class="td2"><a href="<%=basePath %>specialPublish!findSpecialOfStoryByUser.do" class="glz">管理专辑</a></td>
                    <td class="td3">
        ...
        <!--右部内容-->
         	<div class="phoStroyDetailRight">
        		<div class="preNext">
                    ...
                    <div class="next">
                    	<a href="story!searchStoryunpublish.do?id=<s:property value="story.id"/>">
							<i></i>
							<span>下一篇</span>
						</a>
                    </div>  		    
                ...
                <div class="storyCon">
                    ...
                    <div class="typeone">
                    		<table>
                            	<tr>
                                    ...
                                    <td class="td2"><s:property value="story.publishSpecialCat.name"/></td>
                                    <td class="td3"><a href="javascript:" onclick="openSpecial2();">移动到</a></td>
                                </tr>
                    ...
                    <div class="typetwo">
                    	<table>
                            	<tr>
                                    ...
                                    <s:property value="#cats.publishCat.name"/>
                                    </s:iterator>
                                    </td>
                                </tr>
                    ...
                    <div class="edt">
                    	<input class="inputyq" type="button" value="编辑" onclick="location.href='story!editunpublishedstory.do?storyId=<s:property value='story.id'/>';"/>
						<input class="inputsx" type="button" value="发布该作品" onclick="location.href='story!startpublish2.do?storyId=<s:property value='story.id'/>';"/>
                    </div>
                </div>
            </div>
       <!--右部内容-->
