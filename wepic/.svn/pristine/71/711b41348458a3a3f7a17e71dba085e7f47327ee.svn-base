...
<title>wepic管理_配置中心_账户安全_基本安全信息_主页</title>


<link type="text/css" rel="stylesheet" href="<%=basePath %>back/configurationCentre/accountSecurity/css/securityIndex.css" />
...
<!--                </s:if>-->
    ...
    <div class="container_body">
        ...
        <div class="info_detail">
        	<table>
            	<tr>
                	<td rowspan="6" class="td_img"><img src="<s:property value='user.portrait'/>"/></td>
                	<td class="td_char"><label>登录账户</label></td>
                    <td class="td_value td_valueMicro"><label> <s:property value="user.email"/> </label><label>（<s:property value="user.nickName"/>）</label></td>
                    <td class="td_opt"><a href="configure!configuration.do">更换邮箱</a></td>
                </tr>
            	<tr>
                	<td class="td_char"><label>绑定手机</label></td>
                    <td class="td_value td_valueMicro"><label><s:property value="user.mobile"/></label></td>
                    <td class="td_opt"><a href="configure!modifymobile.do">更换号码</a></td>
                </tr>
            	<tr>
                	<td class="td_char"><label>上次登录</label></td>
                    <td class="td_value"><label> <s:date name="loginHistory.loginTime" format="yyyy-MM-dd HH:mm:ss"/> </label></td>
                    <td class="td_opt"><a href="javascript:">不是我的操作？</a></td>
                </tr>
            	<tr>
                	<td class="td_char"><label>实名认证</label></td>
                    <td class="td_value">
                        <!--<label class="approveNo" title="未实名认证">未实名认证</label>
                        <label class="approveHave" title="个人实名认证">个人实名认证</label>-->
                        <label class="approveQy" title="企业实名认证">企业实名认证</label>
                    </td>
                    <td class="td_opt">
                    
                <s:if test="user.personOrCompany == 2 && user.ifIdentityTrue == 1 && user.enterpriceType ==1">
                <a href="configure!govermentvalidateingprocess.do">实名认证</a>
                </s:if>
                <s:if test="user.personOrCompany == 2 && user.ifIdentityTrue == 2 && user.enterpriceType ==1">
                <a href="configure!govermentvalidatesuc.do">实名认证</a>
                </s:if>
                <s:if test="user.personOrCompany == 2 && user.ifIdentityTrue == 3 && user.enterpriceType ==1">
                <a href="configure!organzitionvalidatefail.do">实名认证</a>
                </s:if>
                <s:if test="user.personOrCompany == 2 && user.ifIdentityTrue == 1 && user.enterpriceType ==2">
                <a href="configure!mediavalidateingprocess.do">实名认证</a>
                </s:if>
                <s:if test="user.personOrCompany == 2 && user.ifIdentityTrue == 2 && user.enterpriceType ==2">
                <a href="configure!mediavalidatesuc.do">实名认证</a>
                </s:if>
                <s:if test="user.personOrCompany == 2 && user.ifIdentityTrue == 3 && user.enterpriceType ==2">
                <a href="configure!organzitionvalidatefail.do">实名认证</a>
                </s:if>
                <s:if test="user.personOrCompany == 2 && user.ifIdentityTrue == 1 && user.enterpriceType ==3">
                <a href="configure!enterpricevalidateprocess.do">实名认证</a>
                </s:if>
                <s:if test="user.personOrCompany == 2 && user.ifIdentityTrue == 2 && user.enterpriceType ==3">
                <a href="configure!enterpricevalidatesuc.do">实名认证</a>
                </s:if>
                <s:if test="user.personOrCompany == 2 && user.ifIdentityTrue == 3 && user.enterpriceType ==3">
                <a href="configure!organzitionvalidatefail.do">实名认证</a>
                </s:if>
                <s:if test="user.personOrCompany == 2 && user.ifIdentityTrue == 1 && user.enterpriceType ==4">
                <a href="configure!othervalidateingprocess.do">实名认证</a>
                </s:if>
                <s:if test="user.personOrCompany == 2 && user.ifIdentityTrue == 2 && user.enterpriceType ==4">
                <a href="configure!othervalidatesuc.do">实名认证</a>
                </s:if>
                <s:if test="user.personOrCompany == 2 && user.ifIdentityTrue == 3 && user.enterpriceType ==4">
                <a href="configure!organzitionvalidatefail.do">实名认证</a>
                </s:if>
            	...
            	<tr>
                	<td class="td_char"><label>登录密码</label></td>
                    <td class="td_value">
                    	<span class="password_red"></span>
                        <span class="password_red"></span>
                        <span class="password_gry"></span>
                        <span class="password_gry"></span>
                    </td>
                    <td class="td_opt"><a href="configure!modifypassword.do">修改密码</a></td>
                </tr>
                <tr class="tr_bottom">
                	<td class="td_char"></td>
                    <td class="td_value"><label>安全性</label><label>低</label></td>
                    <td class="td_opt"></td>
                </tr>
            </table>
        </div>
        ...
        <div class="info_autonymIntro">
        	<span>实名认证用于提升账号的安全性和新人级别。</span>
        </div>
        ...
        <div class="binding_ico">
        	<div class="left_ico">
            	<div class="qq_ico"></div>
            	<div class="ico_con">
                	<div class="ico_one">
                    	<span class="span_bing">绑定账户</span>
                        <!--<span class="accut_bing">2121*****12</span>
                        <a href="javascript:">解绑</a>-->
                        <span class="accut_bing">未绑定</span>
                        <a href="javascript:">现在绑定</a>
                    </div>
                	<div class="ico_time"><span>2013年10月8日</span><span class="hour">12:12:02</span></div>
                </div>
            
            </div>
        	<div class="right_ico">
            	<div class="sina_ico"></div>
                <div class="ico_con">
                	<div class="ico_one">
                    	<span class="span_bing">绑定账户</span>
                        <!--<span class="accut_bing">2121*****12</span>
