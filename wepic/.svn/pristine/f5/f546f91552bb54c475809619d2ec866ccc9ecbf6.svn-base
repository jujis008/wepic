...
<title>wepic管理_个人中心_我的约拍_发布约拍_发布作品征集_摄影图片</title>
        	...
        	<div class="divChooseCon">
            	<div class="shootBar">
                	...
                	<s:if test="id==bidCat.id">
                		...
                		<!-- 
                    	<a href="releaseCollect_sytp.html"><li class="active">摄影图片</li></a>
                ...
                <div class="divInfo">
                	<div class="productType">
                            ...
                            <div class="proType">
                            	...
                            	<!-- 
                					<li class="active"><span>人物</span><i></i></li>
                    				<li><span>情绪概念</span><i></i></li>
 				                   	<li><span>生活方式</span><i></i></li>
                			    	<li><span>家居</span><i></i></li>
              				      	<li><span>文化艺术</span><i></i></li>
     				               	<li><span>自然风光</span><i></i></li>
              				      	<li><span>城市风光</span><i></i></li>
     				               	<li><span>旅游地理</span><i></i></li>
     				               	<li><span>动物</span><i></i></li>
              				      	<li><span>科技科学</span><i></i></li>
     				               	<li><span>食物</span><i></i></li>
     				               	<li><span>商业金融</span><i></i></li>
              				      	<li><span>运动</span><i></i></li>
     				               	<li><span>宗教</span><i></i></li>
              				      	<li><span>建筑</span><i></i></li>
     				               	<li><span>汽车</span><i></i></li>
     				               	<li><span>保健美容</span><i></i></li>
              				      	<li><span>时尚服饰</span><i></i></li>
     				               	<li><span>工业</span><i></i></li>
     				               	<li><span>教育</span><i></i></li>
                                     -->
                    	...
                    	<table>
                        	...
                        	<tr>
                            	...
                            	<td class="divNum">
                                    ...
                                    <span class="nums">张</span>
                                </td>
                                <td class="td3">征集截止日期</td>
                                
                                <td class="time" id="choseTime2">
                                	<input class="timeInputStr" name="workEndTime" id="txtEndDate" type="text" readonly="true"/>
                                </td>
                            </tr>
                	...
                	<!--第四行-->
                        ...
                        <!--<div id="collectUnivalence">
                            <div class="character">征集单价</div>
                            
                            <div class="divPrice">
                                
                        		<div class="divTotalPrice">总价：<span>34234</span>元</div>
                        	</div>
                        </div>
                        
                        <div id="collectTotalValue">
                            <div class="character">征集总价</div>
                            
                            <div class="divPrice">
                                <input class="priceinput" type="text"
                                onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}"  
                                        onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'0')}else{this.value=this.value.replace(/\D/g,'')}"/>
                                <span class="pricesp">元</span>
                            </div>
                ...
                <div class="submit">
                            <input type="hidden" value="3" name="bidType" />
                             ...
                             <input type="hidden" value="7" name="sumProductPhoto" />
                             <input type="hidden" name="fileType" value="" id="fileType"/>
            			    <input class="finished" id="finished" type="button" onclick="submit_Sytp();" value="发布"/>
