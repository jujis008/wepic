...
function submitVerification(){
	...
	var addressNull = checkNull('enterpriseAddress','enterpriseAddressRemind');;
	
	var areaCodetNull = checkNull('areaCodet','phoneNumberRemind');
	var phoneNumbertNull = checkNull('phoneNumbert','phoneNumberRemind');
	
	alltResule = (nameNull && zzjgNull && addressNull && areaCodetNull && phoneNumbertNull);
