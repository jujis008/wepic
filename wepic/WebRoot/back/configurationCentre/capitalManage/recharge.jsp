...
<title>wepic管理_配置中心_资金管理_我要充值</title>
...
<link type="text/css" rel="stylesheet" href="<%=basePath %>back/configurationCentre/capitalManage/css/topUpChooseBlank.css" />
<script type="text/javascript" src="<%=basePath %>back/configurationCentre/capitalManage/js/topUpChooseBlank.js"></script>
<script type="text/javascript">
function  selcetPay(type){
    var form=document.getElementById("form1");
    if(type==1){
    	form.action="<%=basePath %>alipay/alipayapi.jsp";
        }else if(type==2){
        	form.action="<%=basePath %>accountRecharge!rechargeByChinaPay.do";
        }else if(type ==3){
            form.action="<%=basePath %>account!transfer.do";
        }
            
	  }

function onclickChage(){
	var val=$("#myrechargeMoney").val();
	if(val==null||val==""){
       $("#moneyError").html("充值金额不能为空");
		return ;
		}
	else if(isNaN(val)){
		 $("#moneyError").html("充值金额只能为数字");
			return ;
		}
	else if(val<1){
		 $("#moneyError").html("充值金额最少为1元");
		}
	 //window.open("", 'win', 'resizable=yes,toolbar=no, menubar=no, location=no, status=no');
...
<!-- 头部结束-->
    ...
    <div class="topUp_chooseBlank">
    	<div class="topUp_top"><h2>我要充值</h2></div>
        
        
    	<div class="topUp_money">
        	<span>待充值账户</span>
            <span class="username"> <s:property value="user.username"/> </span>
        	<span>充值金额</span>
            <input class="topUpMoney" id="myrechargeMoney"  name="myrechargeMoney" type="text" onafterpaste="onlyWriteNum(this);" onkeyup="onlyWriteNum(this);"/>
            <span>元</span>
        </div>
    
    	<div class="topUp_blank" id="topUpBlank">
        	<div class="blank" onclick="selcetPay(1)">
            	<div class="bank_radio"><input type="radio"  name="blank" value="1"  /></div>
            	<div class="bank_ico_zfb"></div>
            </div>
            
            <div class="blank" onclick="selcetPay(2)">
            	<div class="bank_radio"><input type="radio" name="yinlianbank" value="2"/></div>
            	<div class="bank_ico_cup"></div>
            </div>
            
            <div class="blank" onclick="selcetPay(3)">
            	<div class="bank_radio"><input type="radio" name="blank" value="转账支付" />
            	</div>
            	<div class="bank_ico_zz"></div>
            </div>
            
            
            
            <div class="blank">
            	<div class="bank_radio" onclick="selcetPay(2)"><input type="radio" name="bankNumber" value="BOC" />
            	</div>
            	<div class="bank_ico_bc"></div>
            </div>
            
            <div class="blank">
            	<div class="bank_radio" onclick="selcetPay(2)"><input type="radio" name="bankNumber" value="ABC"/>
            	</div>
            	<div class="bank_ico_abc"></div>
            </div>
            
            <div class="blank">
            	<div class="bank_radio" onclick="selcetPay(2)"><input type="radio" name="bankNumber" value="ICBC" />
            	</div>
            	<div class="bank_ico_icbc"></div>
            </div>
            
            <div class="blank">
            	<div class="bank_radio" onclick="selcetPay(2)"><input type="radio" name="bankNumber" value="CCB" />
            	</div>
            	<div class="bank_ico_cbc"></div>
            </div>
            
            <div class="blank">
            	<div class="bank_radio" onclick="selcetPay(2)"><input type="radio" name="bankNumber" value="CMB" />
            	</div>
        ...
        <div class="topUp_submit">
        	<div class="submit_next">
        		<input class="recharge" type="button" value="下一步" onclick="onclickChage()"/>
        	</div>
            <div class="submit_cancel">
        		<a href="javascript:">取消充值</a>
        	</div>
        </div>
    </div>
    </form>
