...
<title>wepic管理_配置中心_资金管理_资金概况_主页</title>
...
<link type="text/css" rel="stylesheet" href="<%=basePath %>back/configurationCentre/capitalManage/css/generalGeneralIndex.css" />
<script type="text/javascript" src="<%=basePath %>back/configurationCentre/capitalManage/js/generalGeneralIndex.js"></script>
<script type="text/javascript">
function recharge(){
location.href="account!userrecharge.do";
}
...
//saveBlank();
var form = document.getElementById("formChooseBlank");
form.action="bankwithdraw!addwithdrawbank.do";  
form.submit(); 
}
</script>
</head>
...
<!-- 头部结束-->
    ...
    <div class="container_general">
    	<div class="general_top"><span>资金概况</span></div>
        <div class="general_cont">
        	<div class="div_left">
            	<div class="char_balance">
                	<span class="spanone">当前余额</span>
                	<span>冻结余额</span>
                	<span class="yuan">2121</span>元
                    
                </div>
            	<div class="now_balance">
                	<span class="money">8797821</span>
                    <span class="yuan">元</span>
                </div>
            	<div class="general_option">
                	<a href="javascript:">充值记录</a>
                	<a href="<%=basePath %>accountWithdraw!userwithdrawlist.do">提现记录</a>
                	<a href="javascript:">收入记录</a>
                	<a href="javascript:">支出记录</a>
                </div>
            </div>
        	...
        	<div class="div_center">
            	<div class="total_earning">
                	<span>目前累计总收入：</span>
                	<span class="money">2121212</span>
                	<span class="yuan">元</span>
                </div>
                
            	<div class="one_month_earning">
                	<span>最近一个月收入：</span>
                	<span class="money">2121212</span>
                	<span class="yuan">元</span>
                </div>
        	...
        	<div class="div_right">
                ...
                <div class="general_right_option">
                    <input class="applicationDeposit" type="button" id="noPassId" value="申请提现" onclick="accountwithdraw()"/>
                    <input class="generalize" type="button" value="推广赚钱" onclick="passOpertion(this,'autonyMaudit','showAll')"/>
<!--                    <input class="recharge" type="button" id="noPassId" value="充值" onclick="noPassReason(this,'autonyMaudit','noPassReason')"/>-->
                    <input class="recharge" type="button" id="noPassId" value="充值" onclick="recharge()"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <!--关联账户-->
    <div class="container_relevance">
    	
    	<div class="relevance_top"><span>关联账户</span></div>
        <div class="relevance_cont">
        	<div class="character_top">提现银行卡：</div>
            <div class="blank_all" id="allBlank">
            <s:iterator value="accountBankWithdraws" var="bankwithdraw">
            <s:if test='#bankwithdraw.bankwithdrawbelongbank == "工商银行"'>
            <s:if test="#bankwithdraw.isdefault ==1">
            <div class="blank">
                	<div class="blank_top">
                    	<div class="card_use"><s:property value="#bankwithdraw.bankwithdrawremark"/></div>
                    ...
                    <div class="blank_ico">
                    	<div class="bank_ico_icbc"></div>			<!--工商银行-->
                    </div>
                    
                    <div class="blank_option">
                    	<div class="deposit_time">
                        	<span class="spano">提现次数：</span>
                    		<span class="tailt"><s:property value="#bankwithdraw.withdrawnumber"/></span>次
                        ...
                        <div class="option_to">
                        	<div class="bj"></div>
                        	<div class="bjc">
                        		<a href="<%=basePath %>bankwithdraw!delbankwithdraw.do?id=<s:property value="#bankwithdraw.id"/>" class="opyDelete">删除</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="blank">
                    ...
                    <div class="blank_option">
                        ...
                        <div class="option_to">
                        	<div class="bj"></div>
                        	<div class="bjc">
                        		<a href="javascript:" class="opyDefault">
                        		<input type="hidden" value="<s:property value="#bankwithdraw.id"/>" />
                        		设为默认</a>
                        		<a href="<%=basePath %>bankwithdraw!delbankwithdraw.do?id=<s:property value="#bankwithdraw.id"/>" class="opyDelete">删除</a>
                            </div>
                        </div>
            ...
            <div class="blank">
                	<div class="blank_top">
                        ...
                        <div class="card_tail_number">
                        	<span class="span_tail">尾号：</span>
                    		<span class="tail_val"><s:property value="#bankwithdraw.bankwithdrawaccountNumber.substring(#bankwithdraw.bankwithdrawaccountNumber.length()-4,#bankwithdraw.bankwithdrawaccountNumber.length())"/></span>
                        </div>
                    </div>
                    
                    <div class="blank_ico">
                    	<div class="bank_ico_bcm"></div>			<!--交通银行-->
                    </div>
            ...
            <div class="blank">
                    ...
                    <div class="blank_ico">
                    	<div class="bank_ico_ccb"></div>			<!--中信银行-->
                    </div>
            ...
            <div class="blank">
                    ...
                    <div class="blank_ico">
                    	<div class="bank_ico_cmb"></div>			<!--招商银行-->
                    </div>
           ...
           <div class="blank">
                    ...
                    <div class="blank_ico">
                    	<div class="bank_ico_cbc"></div>			<!--建设银行-->
                    </div>
            ...
            <div class="blank">
                    ...
                    <div class="blank_option">
                        ...
                        <div class="option_to">
                        	<div class="bj"></div>
                        	<div class="bjc">
                        		<a href="javascript:" class="opyDefault">设为默认
                        		<input type="hidden" value="<s:property value="#bankwithdraw.id"/>" />
                        		</a>
                        		<a href="<%=basePath %>bankwithdraw!delbankwithdraw.do?id=<s:property value="#bankwithdraw.id"/>" class="opyDelete">删除</a>
                            </div>
            ...
            <div class="blank">
                    ...
                    <div class="blank_ico">
                    	<div class="bank_ico_abc"></div>			<!--农业银行-->
                    </div>
            ...
            <div class="blank">
                    ...
                    <div class="blank_ico">
                    	<div class="bank_ico_bc"></div>					<!--中国银行-->
                    </div>
        ...
        <div class="table_con">
        	<table>
                ...
                <tr>
                    ...
                    <td class="td_two"><input class="open_blank" type="text" name="bankwithdrawopenbankname"/></td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="td_two"><input class="blank_number" name="bankwithdrawaccountNumber"  type="text" onkeyup="onlyWriteNum(this);" onafterpaste="onlyWriteNum(this);"/></td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="td_two"><input class="input_remark" type="text" name="bankwithdrawremark"/></td>
                </tr>
            </table>
