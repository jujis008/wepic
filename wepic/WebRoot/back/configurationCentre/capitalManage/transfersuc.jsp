...
<title>wepic管理_配置中心_资金管理_我要充值_充值成功</title>
            ...
            <div class="info_password">
            	<div class="info_success">
                	...
                	<div class="success_right">
                    	<div class="succe">提交成功！</div>
                    	<div class="remin">您的转账信息已收到，我们将在两个工作日内处理您的转账请求。</br>流水单号：<span><s:property value="accountRecharge.orderId"/></span></div>
                    </div>
                </div>
            	
                                
                <div class="password_three">
                    <input type="button" value="完成"  class="login_submit" onclick="finish()"/>
                </div>
            </div>
        </div>
