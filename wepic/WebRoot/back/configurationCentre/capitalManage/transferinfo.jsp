...
<title>wepic管理_配置中心_资金管理_我要充值_我的转账信息</title>
...
<link type="text/css" rel="stylesheet" href="<%=basePath %>back/configurationCentre/capitalManage/css/topUpChooseBlankTransfer.css" />
...
<script>
        $(function () {
            $("#transferTime").calendar({
                controlId: "divDate",                                       // 弹出的日期控件ID，默认: $(this).attr("id") + "Calendar"
                speed: 200,                                                 // 三种预定速度之一的字符串("slow", "normal", or "fast")或表示动画时长的毫秒数值(如：1000),默认：200
                complement: true,                                           // 是否显示日期或年空白处的前后月的补充,默认：true
                readonly: true,                                             // 目标对象是否设为只读，默认：true
               	addToDiv: "transferTimeTD"
                
            });
		});
		function confirmrecharge(){
		submitBlank();
		var form = document.getElementById("formTrans");
		form.action="accountRecharge!recharge.do";  
        form.submit();
...
<!-- 头部结束-->
    ...
    <div class="topUp_chooseBlank">
    	...
    	<table class="table_transferInfo">
        	<tr>
            	<td class="td_one">
                	待充值用户
                </td>
            ...
            <tr>
            	...
            	<td class="td_two">  
                	<input class="transferCardNumber" name="transferaccount" type="text" id="transferCardNumber" onkeyup="onlyWriteNum(this);" onafterpaste="onlyWriteNum(this);"/>
                </td>
            </tr>
            ...
            <tr>
            	...
            	<td class="td_two">
                	<input class="blankCardName" name="transferopenname"  type="text" id="blankCardName"/>
                </td>
            </tr>
            ...
            <tr>
            	...
            	<td class="td_two">
                	<input name="rechargeMoney" class="transferedMoney" type="text" id="transferedMoney" onkeyup="onlyWriteNum(this);" onafterpaste="onlyWriteNum(this);"/> 元
                </td>
            </tr>
            ...
            <tr>
            	...
            	<td class="td_two" id="transferTimeTD">
                	<input class="transferTime" type="text" id="transferTime" name="rechargeTime"/>
                </td>
            </tr>
        </table>
        ...
        <div class="topUp_submit">
        	<div class="submit_next">
            	<input class="applicationDeposit" type="button" value="取消充值" onclick="window.location = 'generalGeneralIndex.html'"/>
        		<input class="recharge" type="button" value="提交"  onclick="confirmrecharge()"/>
        	</div>
        </div>
    </div>
