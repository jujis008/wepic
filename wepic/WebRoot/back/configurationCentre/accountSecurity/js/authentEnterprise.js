...
function submitVerification(){
	...
	var yyqxNull = checkNull('businessDeadline','businessDeadlineRemind');
	
	var qydzNull = checkNull('enterpriseAddress','enterpriseAddressRemind');
	var zczjNull = checkNull('registerCapital','registerCapitalRemind');
	...
	alltResule = (nameNull && dateNull && yyqxNull && qydzNull && zczjNull && yyzzNull &&zzjgNull && zyfwNull);
