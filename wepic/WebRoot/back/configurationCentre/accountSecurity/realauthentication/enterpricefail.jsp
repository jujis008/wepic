...
<title>wepic管理_配置中心_账户安全_实名认证_政府_审核失败</title>
...
<!--                </s:if>-->
    ...
    <div class="container_body">
        ...
        <div class="auditNoPass_bg">
        	<div class="top"><span class="char">实名认证未通过</span>原因如下：</div>
        	<s:if test="user.nopasscause.contains(\"0\")">
        	<s:generator separator="." val="user.nopassreason">
                                   <s:iterator>
                                   <div class="oth"><s:property/></div>
                                   </s:iterator>
                                   </s:generator>
        	...
        	<div class="oth"><a href="<%=basePath %>configure!enterpricevalidate.do">重新提交</a></div>
        </div>
