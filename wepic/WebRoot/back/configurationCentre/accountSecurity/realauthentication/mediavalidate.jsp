...
<title>wepic管理_配置中心_账户安全_实名认证_媒体填写信息</title>
 ...
 $(function () {
		...
		function uploadlicense(){
          $("#upmediaInfo").upload({
			...
			action : 'configurajson_uploadmediaregister.do',
			autoSubmit : true,
...
function linkgoverment(type){
    ...
    function mediasubmit(){
     ...
     var mediaregister=$("#mediaregister").val();
     var shenqinggonghan=$("#shenqinggonghan").val();
     var zhengjianzhao=$("#zhengjianzhao").val();
	 form.action="configure!mediavalidateing.do?mediaenrollment="+mediaregister+"&licenseagreement="+shenqinggonghan+"&idCardFrontPic="+zhengjianzhao;  
	 form.submit();  
     }
    }
</script>
...
<!--                </s:if>-->
    ...
    <form id="formEnterprise" method="post">
     ...
     <input type="hidden" id="mediaregister" />
    ...
    <div class="container_body">
        	...
        	<table>
            	<tr class="tr_enterprise">
                	...
                	<td class="td_two">
						...
						<input type="radio" name="enterpriceType" value="2" id="radioMedia" class="rightI" checked="checked" onclick="linkgoverment(this.value)"/>
            	...
            	<tr class="tr_enterpriseRemind">
                	<td class="td_one"></td>
                    <td colspan="3"><div class="remind_media"><div class="sanjiao"></div>媒体包括：报纸，杂志，电视，电台，通讯社，其他等唯图网用户。</div></td>
                </tr>
                
                <tr class="tr_prove">
                	<td class="td_one"><label>*</label><span>媒体信息登记表</span></td>
                    <td class="td_two">请下载<a href="<%=basePath %>validatedownfile/mediaenrollment.doc">媒体信息登记表</a>按要求填写表格后,上传加盖公章的扫描件,支持jpg、jpeg、bmp、gif格式照片，大小不超过5M。</td>
                ...
                <tr class="tr_chooseFile">
                	<td class="td_one"></td>
                    <td class="td_two">
                    	<input type="button" value="选择文件"  class="upload_pho" id="upmediaInfo" onclick="uploadPhotographImg(this,'imgRegistryForm','uploadSuccessIcoo','uploadRemind1');"/>
                        <span class="span_upPho" id="uploadSuccessIcoo">上传成功</span>
                        <label class="label_remind" id="uploadRemind1"></label>
                    </td>
                	<td class="td_one"></td>
                    <td class="td_two">
                    	<input type="button" value="上传申请公函"  class="upload_pho" id="upmediaInfo2" onclick="uploadPhotographImg(this,'imgOfficialLetter','uploadSuccessIcot','uploadRemind2');"/>
        ...
        <div class="submit">
               <div class="inp">
					...
					<input class="finished" type="button" value="提交" onclick="mediasubmit()"/>
               </div>
        </div>
        </form>
    </div>
