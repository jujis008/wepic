...
<title>wepic管理_配置中心_账户安全_实名认证_首次进入</title>
<script type="text/javascript" src="<%=basePath %>public/js/imgsf.js"></script>

<link type="text/css" rel="stylesheet" href="<%=basePath %>back/configurationCentre/accountSecurity/css/authentFirstCome.css" />
...
<script type="text/javascript" src="<%=basePath %>back/configurationCentre/accountSecurity/js/authentFirstCome.js"></script>
...
function coverupload(){
 $("#uploadcredentials").upload({
    ...
    function myformsubmit(){
     var form = document.getElementById("formIdentity");
     var validateres=submitVerification();
     if(validateres == false){
     }else{
     var picurl=$("#myidcardpic").val();
	 form.action="configure!personvalidateing.do?picurl="+picurl;  
	 form.submit();  
     }
...
<!--                </s:if>-->
    ...
    <input type="hidden" id="myidcardpic" name="myidcardpic" />
    <div class="container_body">
        ...
        <div class="info_table">
        	<table>
            	<tr class="tr_one">
                	<td class="td_one"><label>*</label><span>真实姓名</span></td>
                	<td class="td_two"><input name="realName" id="releName" class="input_text true_name" type="text" onblur="verifyName();"/><label class="label_remind" id="nameRemind"></label></td>
                </tr>
            	
                
            	<tr class="tr_two">
                	<td class="td_one"><label>*</label><span>身份证号</span></td>
                	<td class="td_two" colspan="2">
                    	<div class="divinput">
                        	<input id="identityCard" class="input_text identity_card" type="text" name="idCardNo" onblur="verifyIdentity('identityCard');"/>
                ...
                <tr class="tr_three">
                	...
                	<td class="td_two">
                    	...
                    	<div class="photograph_right">
                        	<div class="character_right">身份证上的所有信息必须清晰可见，照片需免冠，未化妆，手持证件人的五官清晰可见。照片内容必须真实，不得做任何图像处理、修改。支持jpg、jpeg、gif格式，大小不超过5M。</div>
                        	<div class="upload_right">
                        	<input id="uploadcredentials"  type="button" value="上传证件照"  class="upload_pho" />
<!--                            	<input type="button" value="上传证件照"  class="upload_pho" id="uploadBut" onclick="uploadPhotographImg(this,'imgPpreviewPhotograph');"/>-->
                            	<span class="span_upPho" id="uploadSuccessIco">上传成功</span>
            	...
            	<tr class="tr_info">
                	...
                	<td class="td_two">
                    	<input id="mobilePhone" class="input_text mobile_phone" type="text" name="mobile" onblur="verifyMobilePhone();"
                ...
                <tr class="tr_info">
                	...
                	<td class="td_two">
                    	<input name="areaCode" id="areaCode" class="input_text area_code" type="text" 
                    	...
                    	<input name="number" id="phoneNumber" class="input_text phone_number" type="text" 
                ...
                <tr class="tr_info">
                	...
                	<td class="td_two">
                    	<input id="relationAddress" class="input_text relation_address" type="text" name="residence"/>
                    </td>
                </tr>
                ...
                <tr class="tr_info">
                	...
                	<td class="td_two">
                    	<input name="qq" id="qqNum" class="input_text qq_num" type="text"
                         					onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}"  
                                            onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'0')}else{this.value=this.value.replace(/\D/g,'')}"/>
                    </td>
                </tr>
        ...
        <div class="submit">
               <div class="inp">
					...
					<input class="finished" type="button" value="提交" onclick="myformsubmit()"/>
               </div>
        </div>
