...
<title>wepic管理_配置中心_账户安全_实名认证_企业填写信息</title>
...
<!--公共js-->
<script type="text/javascript" src="<%=basePath %>back/js/provinceCity.js"></script>
...
<link type="text/css" rel="stylesheet" href="<%=basePath %>back/configurationCentre/accountSecurity/css/authentEnterprise.css" />

<script type="text/javascript" src="<%=basePath %>/back/configurationCentre/accountSecurity/js/authentEnterprise.js"></script>
...
<script>
		...
		function uploadlicense(){
          $("#uploadlicense").upload({
			...
			action : 'configurajson_uploadlicense.do',
			autoSubmit : true,
    ...
    function enterpricesubmit(){
	 ...
	 form.action="configure!enterpricevalidateing.do?certificatePic="+yingyezhizhao+"&licenseagreement="+shenqinggonghan+"&idCardFrontPic="+zhengjianzhao;  
	 form.submit();  
     }
...
<!--                </s:if>-->
    ...
    <input type="hidden" id="userId" value="<s:property value="user.id"/>"/>
     <input type="hidden" id="yingyezhizhao" />
    ...
    <div class="container_body">
        ...
        <div class="info_table">
        	<table>
            	<tr class="tr_enterprise">
                	...
                	<td class="td_two">
                    	<input type="radio" name="enterpriceType" value="1" id="radioGoverment" onclick="linkgoverment(this.value)"/>
                    	...
                    	<input type="radio" name="enterpriceType" value="3" id="radioEnterprise" class="rightI" checked="checked" onclick="linkgoverment(this.value)"/>
            	...
            	<tr class="tr_enterpriseRemind">
                	<td class="td_one"></td>
                    <td colspan="3"><div class="remind_enterprise"><div class="sanjiao"></div>企业包括：企业，分支机构，企业相关品牌，产品与服务以及招聘，客服类型的唯图网用户。</div></td>
                </tr>
                
                <tr class="tr_enterpriseInfor">
                	<td class="td_one"><label>*</label><span>企业名称</span></td>
                    <td class="td_two"><input id="enterpriseName" name="companyName" class="input_textTop" type="text" onblur="checkNull('enterpriseName','enterpriseNameRemind');"/></td>
                	<td class="td_one"><label>*</label><span>成立日期</span></td>
                    <td class="td_two" id="choseTime"><input name="companyBuildDate" class="timeInputStr" id="txtBeginDate" type="text"  onblur="checkNull('txtBeginDate','txtBeginDateRemind');"/></td>
                </tr>
                <tr class="tr_enterpriseInforRemind">
                	<td class="td_one"></td>
                    <td class="td_two"><label class="label_remind" id="enterpriseNameRemind"></label></td>
                	<td class="td_one"></td>
                    <td class="td_two"><label class="label_remind" id="txtBeginDateRemind"></label></td>
                </tr>
                
                <tr class="tr_enterpriseInfor">
                	<td class="td_one"><label>*</label><span>企业邮箱</span></td>
                    <td class="td_two"><input id="enterpriseEMail" name="companyEmail" class="input_textTop" type="text" onblur="checkEMail('enterpriseEMail','enterpriseEMailRemind');"/></td>
                	<td class="td_one"><label>*</label><span>营业期限</span></td>
                    <td class="td_two">
                    	<input id="businessDeadline" name="busnissAllowedTime" class="input_textTop" type="text" onblur="checkNull('businessDeadline','businessDeadlineRemind');"/>
                        <input type="checkbox" class="checkboxbu"/>长期
                        </td>
                </tr>
                <tr class="tr_enterpriseInforRemind">
                	<td class="td_one"></td>
                    <td class="td_two"><label class="label_remind" id="enterpriseEMailRemind"></label></td>
                	<td class="td_one"></td>
                    <td class="td_two"><label class="label_remind" id="businessDeadlineRemind"></label></td>
                </tr>
                
                <tr class="tr_enterpriseInfor">
                	<td class="td_one"><label>*</label><span>企业地址</span></td>
                    <td class="td_two"><input id="enterpriseAddress" name="companyAddr" class="input_textTop" type="text" onblur="checkNull('enterpriseAddress','enterpriseAddressRemind');"/></td>
                	<td class="td_one"><label>*</label><span>注册资金</span></td>
                    <td class="td_two"><input id="registerCapital" name="companyRegMoney" class="input_textTop" type="text" onblur="checkNull('registerCapital','registerCapitalRemind');"/>万元</td>
                </tr>
                <tr class="tr_enterpriseInforRemind">
                	<td class="td_one"></td>
                    <td class="td_two"><label class="label_remind" id="enterpriseAddressRemind"></label></td>
                	<td class="td_one"></td>
                    <td class="td_two"><label class="label_remind" id="registerCapitalRemind"></label></td>
                </tr>
                
                <tr class="tr_enterpriseInfor">
                	<td class="td_one"><label>*</label><span>营业执照注册号</span></td>
                    <td class="td_two"><input id="businessLicense" name="certificateNo" class="input_textTop" type="text" onblur="checkNull('businessLicense','businessLicenseRemind');"/></td>
                	<td class="td_one"><label>*</label><span>组织机构代码</span></td>
                    <td class="td_two"><input id="organization" name="companyorgcode" class="input_textTop" type="text" onblur="checkNull('organization','organizationRemind');"/></td>
                </tr>
                <tr class="tr_enterpriseInforRemind">
                	<td class="td_one"></td>
                    <td class="td_two"><label class="label_remind" id="businessLicenseRemind"></label></td>
                	<td class="td_one"></td>
                    <td class="td_two"><label class="label_remind" id="organizationRemind"></label></td>
                </tr>
                
                <tr class="tr_enterpriseInfor">
                	<td class="td_one"><label>*</label><span>营业执照所在地</span></td>
                    <td class="td_two" colspan="3">
                    	<div class="address" id="citySelectTag">
                            ...
                            <script type="text/javascript">
                                    new locatArea("中国","北京市","北京市",document.getElementById('citySelectTag'));
                            </script>
                        </div>
                    </td>
                </tr>
                ...
                <tr class="tr_enterpriseInfor">
                	<td class="td_one"><label>*</label><span>经营范围</span></td>
                    <td class="td_two" colspan="3"><input id="manageScope" name="businessScope" class="input_manageScope" type="text" onblur="checkNull('manageScope','manageScopeRemind');"/></td>
                </tr>
                <tr class="tr_enterpriseInforRemind">
                	<td class="td_one"></td>
                    <td class="td_two"><label class="label_remind" id="manageScopeRemind"></label></td>
                </tr>
                
                
                <tr class="tr_prove">
                	<td class="td_one"><label>*</label><span>营业执照扫描件</span></td>
                    <td class="td_two">请下载请上传营业执照清晰彩色扫描件或数码照，在有效期内且年检章齐全（当年成立的可无年检章）由中国大陆工商局颁发。支持jpg、jpeg、bmp、gif格式图片，大小不超过5M。</td>
                	<td class="td_one"><label>*</label><span>企业认证申请公函</span></td>
                    <td class="td_two">请下载<a href="<%=basePath %>validatedownfile/applyletters.doc">企业认证申请公函</a>按要求填写表格后,上传清晰彩色并加盖公章的扫描件,支持jpg、jpeg、bmp、gif格式照片，大小不超过5M。</td>
                </tr>
                </table>
                
                <div class="div_chooseFileBut">
                	<div class="but_preview">
                        <input type="button" value="上传执照"  class="upload_pho" id="uploadlicense" onclick="uploadPhotographImg(this,'imgRegistryForm','uploadSuccessIcoo','uploadRemind1');"/>
                        <span class="span_upPho" id="uploadSuccessIcoo">上传成功</span>
                        <label class="label_remind" id="uploadRemind1"></label>
                    </div>
                    <div class="but_preview">
                        <input type="button" value="上传申请公函"  class="upload_pho" id="uploadletters" onclick="uploadPhotographImg(this,'imgOfficialLetter','uploadSuccessIcot','uploadRemind2');"/>
                ...
                <div class="tr_chooseFileImg">
                    <div class="img_preview">
                        ...
                        <i></i>
                        <div class="character">您的营业执照将显示在此处</div>
                    </div>
                    <div class="img_preview">
                	...
                	<td class="td_two">
                    	...
                    	<div class="photograph_right">
                        	...
                        	<div class="upload_right">
                            	<input type="button" value="上传证件照"  class="upload_pho" id="uploadmyupfile" onclick="uploadPhotographImg(this,'imgPpreviewPhotograph','uploadSuccessIcow','uploadRemind');"/>
        ...
        <div class="submit">
               <div class="inp">
					...
					<input class="finished" type="button" value="提交" onclick="enterpricesubmit()"/>
               </div>
        </div>
        </form>
    </div>
