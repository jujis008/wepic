...
<!--        <div class="audit_bg">实名认证正在审核中......</div>-->
        ...
        <table class="table_top">
        	<tr class="th_top">
            	<th colspan="3"><span>企业认证信息</span></th>
            	<th class="approveType"><span>认证类型：</span><span>
            	<s:if test="user.enterpriceType == 1">
            	政府
            	</s:if>
            	</span></th>
            </tr>
            ...
            <tr class="tr_license">
            	<td class="td_one"><span>政府信息登记表</span></td>
                <td class="td_two">
                	<div class="img_preview">
                    	<table><tr><td id="imgPpreviewPhotograph"><img src="<s:property value="user.govermentenrollment"/>" onload="javascript:DrawImage(this,200,200)" onclick="showImg(this.src);"/></td></tr></table>
                        <i></i>
                        <div class="character">您的政府信息登记表将显示在此处</div>
                    </div>
                </td>
                ...
                <td class="td_four">
                	<div class="img_preview">
                    	...
                    	<!--<img src="../../../pubimg/pic/1.png" onload="javascript:DrawImage(this,200,200)" onclick="showImg(this);"/>--></td></tr></table>
                        <i></i>
            ...
            <tr>
                ...
                <td class="td_five" rowspan="6">
                	<div class="img_preview">
                    	...
                    	<table><tr><td id="imgPpreviewPhotograph"><img src="<s:property value="user.idCardFrontPic"/>" onload="javascript:DrawImage(this,200,200)" onclick="showImg(this.src);"/></td></tr></table>
                        <i></i>
