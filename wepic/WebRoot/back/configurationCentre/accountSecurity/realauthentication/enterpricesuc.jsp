...
<title>wepic管理_配置中心_账户安全_实名认证_政府_审核成功</title>
<script type="text/javascript" src="<%=basePath %>public/js/imgsf.js"></script>

<link type="text/css" rel="stylesheet" href="<%=basePath %>back/configurationCentre/accountSecurity/css/authentGovernmentCheck.css" />
...
<script type="text/javascript" src="<%=basePath %>back/configurationCentre/accountSecurity/js/authentGovernmentCheck.js"></script>
...
<!--                </s:if>-->
    ...
    <div class="container_body">
        ...
        <table class="table_top">
        	<tr class="th_top">
            	<th colspan="4"><span>企业认证信息</span></th>
            	<th class="approveType"><span>认证类型：</span><span>企业</span></th>
            </tr>
            <tr>
            	<td class="td_one"><span>企业名称</span></td>
                <td class="td_two"><span><s:property value="user.companyName"/></span></td>
                <td class="td_edit"></td>
                <td class="td_three">成立时间</td>
                <td class="td_four"> 
                <s:property value="user.companyBuildDate"/>
                </td>
            </tr>
            
            <tr>
            	<td class="td_one"><span>企业邮箱</span></td>
                <td class="td_two"><span><s:property value="user.companyEmail"/> </span></td>
                <td class="td_edit"></td>
                <td class="td_three">营业期限</td>
                <td class="td_four"><s:property value="user.busnissAllowedTime"/>年</td>
            </tr>
            
            <tr>
            	<td class="td_one"><span>企业地址</span></td>
                <td class="td_two"><span> <s:property value="user.companyAddr"/> </span></td>
                <td class="td_edit">
                	<a onclick="editaddrObj(this,'inputEnteAddress');">修改</a>
                </td>
                <td class="td_three">注册资金</td>
                <td class="td_four"><s:property value="user.companyRegMoney"/></td>
            </tr>
            
            <tr>
            	<td class="td_one"><span>营业执照注册号</span></td>
                <td class="td_two"><span> <s:property value="user.certificateNo"/> </span></td>
                <td class="td_edit"></td>
                <td class="td_three">组织机构代码</td>
                <td class="td_four"> <s:property value="user.companyorgcode"/> </td>
            </tr>
            
            <tr>
            	<td class="td_one"><span>营业执照所在地</span></td>
                <td class="td_two"><span> <s:property value="user.companyRegAddr"/> </span></td>
            </tr>
            
            
            <tr>
            	<td class="td_one"><span>经营范围</span></td>
                <td class="td_two"><span> <s:property value="user.businessScope"/> </span></td>
                <td class="td_edit">
                	<a onclick="editbusinessScopeObj(this,'inputRelationManageScope');">修改</a>
                </td>
            </tr>
            
            
            <tr class="tr_license">
            	<td class="td_one"><span>营业者执照扫描件</span></td>
                <td class="td_two">
                	<div class="img_preview">
                    	<table><tr><td id="imgPpreviewPhotograph">
                    	
                    	<img src="<s:property value="user.certificatePic"/>" alt="" onload="javascript:DrawImage(this,200,200)" onclick="showImg(this.src);"/>
                    	</td></tr></table>
                        <i></i>
                        <div class="character">您的营业者执照将显示在此处</div>
                    </div>
                </td>
                <td class="td_edit"></td>
                <td class="td_three"><span>企业认证申请公函</span></td>
                <td class="td_four">
                	<div class="img_preview">
                    	<table><tr><td id="imgPpreviewPhotograph">
                    	<img src="<s:property value="user.licenseagreement"/>" alt="" onload="javascript:DrawImage(this,200,200)" onclick="showImg(this.src);"/>
                    	<!--<img src="../../../pubimg/pic/1.png" onload="javascript:DrawImage(this,200,200)" onclick="showImg(this);"/>-->
                    	</td></tr></table>
                        <i></i>
        ...
        <table class="table_main">
        	<tr class="th_top">
            	<th colspan="5"><span>运营者认证信息</span></th>
            </tr>
            <tr>
            	<td class="td_one"><span>运营者姓名</span></td>
                <td class="td_two"><span><s:property value="user.markerName"/></span></td>
                <td class="td_three"></td>
                <td class="td_four">运营者身份证照</td>
                <td class="td_five" rowspan="6">
                	<div class="img_preview">
                    	<table><tr><td id="imgPpreviewPhotograph">
                    	
                    	<img src="<s:property value="user.idCardFrontPic"/>" alt="" onload="javascript:DrawImage(this,200,200)" onclick="showImg(this.src);"/>
                    	</td></tr></table>
                        <i></i>
            ...
            <tr>
            	<td class="td_one"><span>运营者身份证号</span></td>
                <td class="td_two"><span><s:property value="user.markerIDCard"/></span></td>
                <td class="td_three"></td>
            </tr>
            
            <tr>
            	<td class="td_one"><span>部门职务</span></td>
                <td class="td_two"><span><s:property value="user.markerduty"/></span></td>
                <td class="td_three"><a onclick="editObjduty(this,'inputTelephone');">修改</a></td>
            </tr>
            
            <tr>
            	<td class="td_one"><span>手机号码</span></td>
                <td class="td_two"><span><s:property value="user.mobile"/></span></td>
                <td class="td_three"><a onclick="editMobilePhone(this);" id="editMobilePhone">修改</a></td>
                <td class="td_four"></td>
            </tr>
            
            <tr>
            	<td class="td_one"><span>联系地址</span></td>
                <td class="td_two"><span><s:property value="user.residence"/></span></td>
                <td class="td_three"><a onclick="editObj(this,'inputRelationAddress');">修改</a></td>
                <td class="td_four"></td>
            </tr>
            
            <tr>
            	<td class="td_one"><span>固定电话</span></td>
                <td class="td_two"><span><s:property value="user.worktel"/></span></td>
                <td class="td_three"><a onclick="editObjtel(this,'inputTelephone');">修改</a></td>
                <td class="td_four"></td>
            </tr>
            
            <tr>
            	<td class="td_one"><span>QQ号码</span></td>
                <td class="td_two"><span> <s:property value="user.qq"/> </span></td>
                <td class="td_three"><a onclick="editObjqq(this,'inputQQNumber');">修改</a></td>
                <td class="td_four"></td>
            </tr>
