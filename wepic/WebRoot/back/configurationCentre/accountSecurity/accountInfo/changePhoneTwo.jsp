...
<title>wepic管理_配置中心_账户安全_基本安全信息_修改手机_密码方式</title>
...
function validatemobilecode(){
	...
	var newmobile=$("#nextOnePassword").val();
	if(writecode == null || writecode == ""){
	   ...
	   $.ajax({
	      type:"Post",
		  url: "configurajson_validatemobilecode.do",
		  data:"mobilecode="+writecode+"&newmobile="+newmobile,
		  success : function(data) {
          var statu=data.state;
              if(statu == 1){
                   location.href="configure!changephonesuc.do";
              }else{
        ...
        <div class="info_detail">
        	<div class="div_step">
            	<div class="step_character">
            		...
            		<div class="step_now_character">新手机验证</div>
            ...
            <div class="info_password">
            	<table>
                	<tr class="tr_one">
                    	<td class="td_one"><span class="span_password">新手机号</span></td>
                    	<td class="td_two"><input class="input_phone" type="text" value="" id="nextOnePassword" onblur="checkSubmitMobil();"/>
                    	<input type="hidden" id="userid" value="<s:property value='user.id'/>"/>
                    	<input type="hidden" id="oldmobile" value="<s:property value='user.mobile'/>"/>
                    	</td>
                    	<td><label id="passReminds" style="width: 200px;">目前仅支持中国大陆手机号</label></td>
                    </tr>
                	<tr class="tr_two">
                   		<td class="td_one"><span class="span_password">验证码</span></td>
                   		<td class="td_two"><input class="input_mobile" type="text" value="" id="nextOnePasswordPhone"  disabled="disabled"/></td>
                        <td><input type="button" value="获取短信验证码" class="achBut" id="achieveBut" onclick="achieveMobile2('nextOnePassword','userid','nextOnePasswordPhone','oldmobile','passReminds');"/></td>
                    </tr>
                    <tr>
                   		<td class="td_one"></td>
                   		<td class="td_two"><label id="passRemind"></label></td>
                	...
                	<tr class="tr_four">
                   		<td></td>
                   		<td><a href="<%=basePath %>configure!securityIndex.do">取消操作</a></td>
