...
<link type="text/css" rel="stylesheet" href="../css/changePhone.css" />
...
<script type="text/javascript" src="../js/changePhone.js"></script>
     ...
     <!-- 导航 -->
  	<div id="assistantBar">
    	<div class="twoStage" id="divTwoStage">
        	<a href="javascript:"><div class='bar active'><span>账户安全</span><i></i></div></a>
        ...
        <div id="divThreeStage">
            <div class="threeStage">
                <a href="../securityIndex.html"><div class='bar active'><span>基本安全信息</span><i></i></div></a>
        ...
        <div class="info_detail">
            ...
            <div class="info_password">
                ...
                <div class="password_three">
                    <input type="submit" value="重新修改"  class="login_submit" onclick="window.location='changePhoneByPassword.html'"/>
                </div>
            </div>
        </div>
