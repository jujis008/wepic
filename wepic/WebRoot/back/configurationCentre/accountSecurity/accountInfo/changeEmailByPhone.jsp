...
window.onload = function(){
	...
	if(writecode == null || writecode == ""){
	   $("#passRemind").html("请输入手机验证码");
	   $("#passRemind").css("color","#FF0000");
	}else{
	   $.ajax({
	      type:"Post",
		  url: "configurajson_validatemobilecode2.do",
		  data:"mobilecode="+writecode,
		  success : function(data) {
          var statu=data.state;
              if(statu == 1){
                   location.href="configure!changesteptwo.do";
              }else{
                   $("#passRemind").html("手机验证码输入错误");
			       $("#passRemind").css("color","#FF0000");
              }        
		  }
	  });
        ...
        <div class="info_detail">
        	<div class="div_step">
            	<div class="step_character">
            		<div class="step_now_character">验证密码</div>
            		<div class="step_gey_character">输入新邮箱</div>
            		<div class="step_gey_character">输入邮箱验证码</div>
            ...
            <div class="info_password">
            	<table>
                	<tr class="tr_phone">
                    	<td class="td_one"><span class="span_password">绑定手机</span></td>
                    	<td class="span_phone"><span>
                    	<s:property value="user.mobile.substring(0,3)"/>****<s:property value="user.mobile.substring(7,11)"/>
                    	<input type="hidden" value="<s:property value='user.id'/>" id="userId"/>
                    	</span><input type="button" value="获取短信验证码" class="achBut" id="achieveBut" onclick="achieveMobile('nextOnePasswordPhone','userId');"/></td>
                    	<td></td>
                    </tr>
                
                	<tr class="tr_coad">
                    	<td class="td_one"><span class="span_password">短信验证码</span></td>
                    	<td><input class="input_mobile" type="text" value="" id="nextOnePasswordPhone"  disabled="disabled" /></td>
                    </tr>
                	<tr class="tr_a">
                    	<td></td>
                    	<td>
                        	<a href="<%=basePath %>configure!configuration.do">使用登录密码验证</a>
                ...
                <div class="password_three">
                    <input type="button" value="下一步"  class="login_submit" onclick="validatemobilecode()"/>
<!--                    <input type="submit" value="下一步"  class="login_submit" onclick="nextMobile('nextOnePasswordPhone','passRemind');"/>-->
                </div>
