        ...
        <div class="info_detail">
        	<div class="div_step">
            	<div class="step_character">
            		<div class="step_now_character">当前手机验证</div>
            ...
            <div class="info_password">
            	<table>
                	<tr class="tr_phone">
                    	...
                    	<input type="hidden" value="<s:property value='user.id'/>" id="userId"/></span>
                    	<input type="button" value="获取短信验证码" class="achBut" id="achieveBut" onclick="achieveMobile('userId','nextOnePasswordPhone');"/></td>
                    	<td></td>
                    </tr>
                	...
                	<tr class="tr_a">
                    	<td></td>
                    	<td>
                        	<a href="<%=basePath %>user!modifymobile.do">使用登录密码验证</a>
                ...
                <input type="submit" value="下一步"  class="login_submit" onclick="validatemobilecode()"/>
<!--                    <input type="submit" value="下一步"  class="login_submit" onclick="nextOneMobile('nextOnePasswordPhone','passRemind');"/>-->
                </div>
