...
<title>wepic管理_配置中心_账户安全_基本安全信息_修改密码</title>


<link type="text/css" rel="stylesheet" href="<%=basePath %>back/configurationCentre/accountSecurity/css/changePassword.css" />
...
<script type="text/javascript" src="<%=basePath %>back/configurationCentre/accountSecurity/js/passwordStrength.js"></script>
<!--公共css-->
...
<script type="text/javascript" src="<%=basePath %>back/configurationCentre/accountSecurity/js/changePassword.js"></script>
    ...
    <div class="container_body">
        ...
        <div class="info_detail">
            ...
            <div class="info_password">
            	<table>
                	<tr class="tr_one">
                    	<td class="td_one"><span>旧密码</span></td>
                    	<td class="td_two"><input class="all_password" type="password" id="oldPassword" onblur="oldPasswordTwo('oldPassword','oldPasswordRemind');"/></td>
                    	<td class="td_three"><label>请输入旧密码</label></td>
                    </tr>
                    <tr class="tr_remind">
                    	<td class="td_one"></td>
                    	<td class="td_two"><label id="oldPasswordRemind"></label></td>
                    </tr>
                	...
                	<tr class="tr_one">
                   		<td class="td_one"><span>输入新密码</span></td>
                   		<td class="td_two"><input class="all_password" type="password" id="newPassword" onblur="newPassword('newPassword','newPasswordRemind');"/></td>
                    	<td class="td_three">
                        	<div id="allStrength">
                            ...
                            <div>
                                <label id="passRemind">密码强度</label>
                            </div>
                    ...
                    <tr class="tr_remind">
                    	<td class="td_one"></td>
                    	<td class="td_two"><label id="newPasswordRemind"></label></td>
                    </tr>
                	...
                	<tr class="tr_one">
                   		<td class="td_one"><span>确认新密码</span></td>
                   		<td class="td_two"><input class="all_password" type="password" id="rePassword"></input></td>
                    </tr>
                    
                    <tr class="tr_remind">
                    	<td class="td_one"></td>
                    	<td class="td_two"><label id="rePasswordRemind"></label></td>
                    </tr>
                    
                	<tr class="tr_four">
                   		<td></td>
                   		<td><input type="submit" value="提交"  class="change_submit" id="loginSubmit" onclick="changePassSubmit();"/></td>
