...
<script type="text/javascript">
    function usecurrentemailvalidate(){
      var email=$("#useremail").val();
      if(email == null || email == ""){
          alert("您尚未绑定邮箱");
      }else{
          location.href="configure!changephonebycurrentemail.do";
      }
    }
    ...
    $.ajax({
              ...
              if(statu == 0){
                 ...
                 window.location = "configure!changephonesteptwo.do";
              }
    ...
    <div class="container_body">
        ...
        <div class="info_detail">
            ...
            <div class="info_password">
            	<table>
                	<tr class="tr_one">
                    	<td class="td_one"><span class="span_password">输入登录密码</span></td>
<!--                    	<input type="hidden" id="uid" value="<s:property value='user.id'/>" />-->
                    	<input type="hidden" id="uid" value="<s:property value='user.id'/>" />
                    	<input type="hidden" id="useremail" value="<s:property value='user.email'/>" />
                    	<td class="td_two"><input class="input_password" type="password" value="" id="nextOnePassword" /></td>
                    	<td><label id="passRemind">输入您的唯图网账户登录密码</label></td>
                    </tr>
                	<tr class="tr_two">
                   		<td class="td_one"></td>
                   		<td class="td_two">
                   		<a onclick="usecurrentemailvalidate()" style="cursor: pointer;">使用当前邮箱验证</a>
<!--                   		<a href="changePhoneByPhone.html">使用当前手机验证</a>-->
                   		</td>
...
<!--                   		<input type="submit" value="下一步"  class="login_submit" id="loginSubmit" onclick="nextOne('nextOnePassword','passRemind');"/>-->
                   		<input type="button" value="下一步"  class="login_submit" id="loginSubmit" onclick="inputcurrentpwd()"/>
                   		</td>
