...
<title>wepic管理-个人中心-我的约拍-发布-商业拍摄-产品拍摄</title>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/back/personalCentr/bid/js/releaseComShoot_cpform.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/back/personalCentr/bid/js/releaseComShoot_cp.js"></script>
...
<script>
        $(function () {
           ...
           $("#divdropDownPartType").find("span").each(function(){
                $(this).click(function(){
                  //alert($(this).html());
                	$("#bidtag").val($.trim($(this).html()));
        ...
        <form action="${pageContext.request.contextPath}/bid!addBid.do" method="post" id="bidaddForm">
        	...
        	<div class="center">
                    ...
                    <div class="divPartEnv">
                    	<table>
                        	<tr>
                                ...
                                <td class="ModelDemandtd"><span>模特需求
                                
                                
                                <input type="hidden" name="isHaveModel" id="isHaveModel" />
                                </span></td>
                                <td>
                                	<div class="divdropDown">
                    					<div class="dropDownBox" id="dropDownBoxModelDemand" onclick="showBelow('divdropDownModelDemand')">
                    						<span id="divdropDownViewModelDemand"></span>
                        					<div class="dropDownBoxR"><i></i></div>
                    					</div>
                    
                    					<div class="dropDownBoxValue" id="divdropDownModelDemand">
                    						<span class='dropValue' id="1">需要模特</span>
                       						<span class='dropValue' id="0">不需要模特</span>
                 			   			</div>
                  					</div>
                                </td>
                            </tr>
                ...
                <div class="divPartNum">
                	<span class="left">产品数量</span>
                	<input class="inputPartNum" type="text" name="sumProdct"/>
                    <span class="spanPartNumz">件</span>
                    <span class="spanPerNumcp">每件产品需正片</span>
                ...
                <div class="divPartOffer divPartOffercp">
                	<table class="tablePartOffer">
                    	<tr>
                            ...
                            <td class="td2"><input type="radio" name="unitpriceType" value="1" id="perPrice" checked="checked"/></td>
                            <td class="td3"><label for="perPrice">每件产品拍摄价</label></td>
                        ...
                        <tr>
                            <td class="td2"><input type="radio" name="unitpriceType" value="2" id="totalPrice"/></td>
                            <td class="td3"><label for="totalPrice">每张正片价格</label></td>
                            <td class="td4"><input type="text" onblur="CounttotalMoney(this)" onfocus="checkedRadio(this)"/></td>
                            <td class="td5"><span>每件产品：</span><span class="y">0</span><span>元</span></td>
