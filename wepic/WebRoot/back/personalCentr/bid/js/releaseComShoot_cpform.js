   function validateBidForm(){
    ...
    var sumProdct=$("input[name=sumProdct]").val();
    if(sumProdct==null||$.trim(sumProdct)==""||isNaN(sumProdct)){
    	$("input[name=sumProdct]").css({"border":"1px solid #F09494"});
          return false;
    	}
...
function CounttotalMoney(obj){
	...
	if(value==3){
		...
		var sumProdct=$("input[name=sumProdct]").val();
		var unitMoney=$(obj).val()*sumProdct;
