...
<title>wepic管理-个人中心-我的约拍-发布-商业拍摄-发布作品征集项目</title>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/back/personalCentr/bid/js/collectProjectform.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/back/personalCentr/bid/js/collectProject.js"></script>
        	...
        	<div class="center">
                ...
                <table>
                	<tr>
                        ...
                        <td><span class="left">作品类型</span></td>
                        <td>
                        	<div class="divdropDown" id="divdropDown-1">
                    			...
                    			<div class="dropDownBoxValue" id="divdropDownPartType">
                    				<span class='dropValue'>摄影图片</span>
                    			</div>
                  			</div>
                        </td>
                    </tr>
                ...
                <div class="divPartTime divPartTimebq">
                	<div class="one" id="choseTime">
                    	<table>
                			<tr>
                    			<td><span class="left">征集截止
                    			<input class="timeInputStr"  id="workEndTime" type="hidden" name="workEndTime"/></span></td>
                				<td><input class="timeInputStr" id="txtEndDate" type="text"/></td>
                        		<td>
                                ...
                                <td class="zpzjsl">征集作品数量</td>
                                <td><input class="inputzpzjsl" type="text" name="imgSum" id="imgSum"/></td>
                                <td>件</td>
                                
                            </tr>
                            
                            <tr class="Copyrighttr">
                    			<td><span class="left">版权属性
                    			<input class="inputzpzjsl" type="hidden" name="copyRighyt" id="copyRighyt"/>
                    			</span></td>
                				<td>
                                	<div class="divdropDown">
                    					<div class="dropDownBox" onclick="showBelow('divdropDownCopyright')">
                    						<input type="hidden" name="shootingEnvironment" id="shootingEnvironment" />
                    						<span id="divdropDownViewCopyright"></span>
                        					<div class="dropDownBoxR"><i></i></div>
                    					</div>
                    
                    					<div class="dropDownBoxValue" id="divdropDownCopyright">
                    						<span class='dropValue'>征集版权作品</span>
                    						<span class='dropValue'>征集作品使用权</span>
                    					</div>
                  					</div>
                                </td>
                ...
                <div class="divPartOffer">
                	<table class="tablePartOffer">
                    	<tr>
                        	<td rowspan="2" class="td1"><span class="">邀约酬金</span></td>
                            <td class="td2"><input type="radio" name="unitpriceType" value="2" id="perPrice" checked="checked"/></td>
                            <td class="td3"><label for="perPrice">每件酬金</label></td>
                            <td class="td4"><input type="text" name="unitpriceProduct" onblur="CounttotalMoney(this)" onfocus="checkedRadio(this)"/></td>
                        ...
                        <tr>
                            <td class="td2"><input type="radio" name="unitpriceType" value="3" id="perPrice"/></td>
                            <td class="td3"><label for="totalPrice">总酬金</label></td>
                            <td class="td4"><input type="text" name="totalMoney" onblur="CounttotalMoney(this)" onfocus="checkedRadio(this)" /></td>
                            <td class="td5"><span>每件：</span><span class="y">0</span><span>元</span></td>
                ...
                <div class="divBidType">
                	<table>
                    	<tr>
                            ...
                            <td><span class="invitesp1">添加附件</span></td>
                ...
                <div class="submit">
               		...
               		<input type="hidden" value="0" name="ifNeedbill" />
