...
function AllredNew(){
	var allnew = $("#AllredNew").find(".redNew");
	$(allnew).each(function(index, element) {
        $(this).click(
			function(){openPopUpBox('zhongbiaozg');}
		);
    });
}
...
function openBidT(bidHidden){
	cloosePopBox('zhongbiaozg');
	openPopUpBox('chooseWork');
