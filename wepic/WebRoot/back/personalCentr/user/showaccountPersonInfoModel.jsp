...
<script type="text/javascript">
   function openNewwindow(){
     window.location.href="${pageContext.request.contextPath}/user!editeUserInfo.do?message=um";
...
<!-- 头部结束-->
    ...
    <div id="divModelFin">
        ...
        <div class="tableContent">
        	<table class="table">
            	<tr>
                	<td class="show">身高</td><td class="val"><s:property value="user.height"/>cm</td>
                    <td class="show">体重</td><td class="val"><s:property value="user.weight"/>kg</td>
                    <td class="show">发色</td><td class="val"><s:property value="user.hairColor"/></td>
                </tr>
            	<tr>
                	<td class="show">胸围</td><td class="val"><s:property value="user.bust"/></td>
                    <td class="show">腰围</td><td class="val"><s:property value="user.waist"/></td>
                    <td class="show">臀围</td><td class="val"><s:property value="user.newhip"/></td>
                </tr>
                
                <tr>
                	<td class="show">鞋码</td><td class="val">
                	<s:property value="user.shoeSize"/></td>
