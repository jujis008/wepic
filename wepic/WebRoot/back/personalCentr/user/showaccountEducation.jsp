...
<title>wepic管理_个人中心_账户基本资料_教育情况显示</title>
...
<script type="text/javascript"  src="${pageContext.request.contextPath}/back/personalCentr/user/js/accountHead.js" />
...
<!-- 头部结束-->
    ...
    <div id="divEnterpriseInfoFin">
   		<div class="title">
        	<h2>教育情况</h2>
            <input type="button" value="编辑" class="edit" onclick='window.location.href="${pageContext.request.contextPath}/user!getByEducation.do?message=ed"' />
        </div>
        
        <div class="tableContent">
        	<table class="table">
            	<tr><td class="show">毕业学校</td><td class="val name">
            	<s:property value="user.highestDegreeSchool"/>
            	
            	</td></tr>
            	<tr><td class="show">毕业日期</td><td class="val"><span><s:property value="user.highestDegreeDate"/></span></td></tr>
            	<tr><td class="show">院系</td><td class="val"><s:property value="user.bachelorSchool"/></td></tr>
            	<tr><td class="show">专业</td><td class="val"><s:property value="user.major"/></td></tr>
            	<tr><td class="show">最高学历</td><td class="val"><s:property value="user.highestDegreeSchool"/></td></tr>
            </table>
        </div>
    </div>
    <!--内容-->
...
function openNewWindowPage(){
	//alert("sssssssssssss");
	window.location.href="${pageContext.request.contextPath}/user!getByEducation.do?message=ed";
