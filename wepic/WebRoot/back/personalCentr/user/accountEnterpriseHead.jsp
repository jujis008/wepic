...
<html>
  <head>
    ...
    <title>wepic管理 个人中心 账户基本资料企业头像</title>
    <link rel="shortcut icon" href="${pageContext.request.contextPath}/public/images/logoSmall.ico"/>
    <link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/back/personalCentr/user/css/accountEducationHead.css" />
...
$(function(){
	$("#fileipload").upload({
		...
		action : '${pageContext.request.contextPath}/frontlogin_enterpriseHeadautoUpload.do',
		autoSubmit : true,
        ...
        onComplete: function (data, self, element){  
        	 var data1 = eval("(" +data +")");
        	// alert(data1.message.indexOf("errorSize")!=-1);
        	if(data1.message.indexOf("errorSize")!=-1){
        		$(".big").html("<img src='${pageContext.request.contextPath}/back/pubimg//defaultHead_150.png'><div class='bige'><span style='color:red'>上传文件尺寸不对</span></div>");
        		return;
        	}
        	var path=data1.message.split(",");
        	$(".big").html("<img id='newuploadpic' src='"+path[0]+"'/><div class='bige'>150&nbsp;×&nbsp;150</div>");
        	$(".small").html("<img id='newuploadpic' src='"+path[1]+"'/><div class='smalle'>80&nbsp;×&nbsp;80</div>");
        	$("#bigEenterpriseImg").val(path[0]);
        	$("#smallEenterpriseImg").val(path[1]);
			}
...
function subForm(){
	if($("#bigEenterpriseImg").val()!=null&&$("#bigEenterpriseImg").val()!="")

$("#formAccountEducationHead").submit();
...
<!-- 头部结束-->
    ...
    <!--内容-->
    <div id="divAccountEducationHead">
   		<form  id="formAccountEducationHead" action="${pageContext.request.contextPath}/user!saveEnterpriseImg.do">
        	<div class="title">
        		<h2>修改头像</h2>
        	</div>
            
            <div class="conennt">
            	<div class="conenntHead">
                	<div class="big">
                    	<img src="${pageContext.request.contextPath}/back/pubimg/defaultHead_150.png" />
                    	<div class="bige">150&nbsp;×&nbsp;150</div>
                    </div>
                    <div class="small">
                    	<img src="${pageContext.request.contextPath}/back/pubimg//defaultHead_80.png" />
                    	<div class="smalle">80&nbsp;×&nbsp;80</div>
                    </div>
                </div>
                
                <div class="inputButtom">
                	<input class="localPhoto" id="fileipload" type="button" value="上传企业头像" />
                    <p class="p1">推荐上传企业品牌标识作为您的头像</p>
                    <p class="p2">要求尺寸为150*150px</p>
                </div>
        	</div>
            
            <div class="submit">
            	<div class="input">
            	 <input type="hidden" value="" name="portrait" id="bigEenterpriseImg"/>
                    <input type="hidden" value=""  name="smallportrait" id="smallEenterpriseImg"/>
                       <input type="reset" value="取消" class="reset"/>
                	<input type="button" value="提交" class="submit" onclick="subForm()"/>
                </div>
        	</div>
   		</form>
    </div>
