    	...
    	for(var i=0;i<bolewDivSpan.length;i++){
    		   bolewDivSpan[i].onclick=function (){
    			/*document.getElementById(showValue).innerHTML = this.innerHTML;*/
            	 ...
            	 $("#publishParentTypeId").val("");
            	 $("#publishParentTypeName").val("");
            	 $("#publishStaute").val("");
            	 $("#publishStauteName").val("");
   		...
   		<div class="head">
        	...
        	<div class="edit">
            	...
            	<input type="hidden" name="pageNo"  id="pageNo" value="1"/>
              	...
              	<div class="char">
               	...
               	<div class="inp">
               		<input class="inputup" type="button" value="上传作品" onclick="location.href='workUpload.html'"/>
					<input class="finished" type="button" value="发布作品" onclick="window.open('chooseRelWork.html');"/>
               	</div>
        	</div>
            <!--编辑-->
            ...
            <div class="sort">
                ...
                <div class="editSelect" id="divCategory">
                    	...
                    	<div class="belowValue" id="divSelectdeCategoryValue" >
                        ...
                        <div class="ppointPaging">            
                            <table class="tablePpointPaging">
                                    <tr>
                                        ...
                                        <td class="ppointPagingOne"><a href="javascript:changePage(1)"></a></td>
                                        <td class="ppointPagingPre">
                                        <s:if test="pager.pageNo-1>0">
                                        <a href="javascript:changePage(<s:property value="pager.pageNo-1"/>)"></a>
                                        </s:if>
                                        <s:else>
                                        
                                        <a href="javascript:changePage(<s:property value="pager.pageNo"/>)"></a>
                                        </s:else>
                                        </td>
                                        <s:iterator begin="1" end="pager.lastPageNo" status="ind">
                                         <td class="ppointPagingN"><a href="javascript:changePage(<s:property value="#ind.index+1"/>)">
                                         <s:property value="#ind.index+1"/>
                                                    ...
                                                    <td class="ppointPagingNext"><a href="javascript:changePage(<s:property value="pager.pageNo+1"/>)"></a></td>
                                                    </s:if>
                                                    <s:else>
                                                     <td class="ppointPagingNext"><a href="javascript:changePage(<s:property value="pager.lastPageNo"/>)"></a></td>
                                                    </s:else>               
                                        
                                        <td class="ppointPagingLast"><a href="javascript:changePage(<s:property value="pager.lastPageNo"/>)"></a></td>
                                    </tr>
                                </table>
                        </div>
                    </div>
