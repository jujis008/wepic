...
<title>wepic管理_个人中心_我的作品库_上传作品</title>
<script type="text/javascript">

 var userid='<s:property value="#session.id"/>';
 var publishSpecialCatId='<s:property value="#session.id"/>';
 var path='${pageContext.request.contextPath}';
</script>


<script type="text/javascript" src="<%=basePath %>public/js/jquery.js"></script>
<script type="text/javascript" src="<%=basePath %>back/personalCentr/myworklib/js/workUpload.js"></script>
...
<link type="text/css" rel="stylesheet" href="<%=basePath %>back/personalCentr/myworklib/css/workUpload.css" />
...
<script type="text/plain" id="upload_ue"></script>
   <script type="text/javascript">
   <%
	String upPage=request.getHeader("Referer");//
	if(upPage!=null&&!upPage.equals("")){
		upPage=upPage.substring(request.getHeader("Referer").lastIndexOf("!")+1,request.getHeader("Referer").lastIndexOf("."));	
	}else{
		upPage="";		
	}
	%>
   var uri="<%=upPage%>";
    ...
    var fileLength=20;
    var path="${pageContext.request.contextPath}";
    if(uri=="searchByTermfromMylibforPublish"){
    	fileLength=1;
	   //alert( $(this).contents().find("#fileLength").val());
	   sentType="searchByTermfromMylibforPublish";
    ...
    function upImage() {
        ...
        $("#edui4").remove();
        $("#edui5").remove();
        $("#edui3_titlebar").remove();
        // $("#edui3_iframe");//.contents().find("#isssframe中的控件ID")
        $("#idtabse").append($("#edui3_iframe"));
        $("#edui_fixedlayer").css({"display":"none"});
        //parent.frames["edui3_iframe"].window.inits();
    ...
    function gotoNewPage(){
       // alert("ssssssss");
    window.location.href="${pageContext.request.contextPath}//publish!findAllMyLib.do"
...
<div id="container">
	<div id="topBar">
	<div id="topbar"><!-- searchByTermfromMylibforPublish  
	                      searchByTermfromMylibforPublish -->
    	<div id="topcenterbar">
   ...
   <div class="twoStage" id="divTwoStage">
        ...
        <div id="divThreeStage">
         ...
         <div class="threeStage">
            ...
            <a href="${pageContext.request.contextPath}/back/personalCentr/myworklib/workUpload.jsp"><div class='bar active'><span>上传作品</span><i></i></div></a>
    ...
    <!--内容-->
    <div id="divWorkLibUpLoad">
   		<div class="character">
        	<span class="upl">上传作品</span>
        	<span class="more">按下CTRL键可以多选，上传单个作品大小应超过100M</span>
            
            <span class="sp1">您已选择</span>
            <span class="hre" id="yixuanze">0</span>
            <span class="sp2">张待上传作品，还可选择</span>
            <span class="hre" id="kexuanze">0</span>
            <span class="sp3">张</span>
        </div>
        
        <div class="content" id="idtabse">
        ...
        <div class="submit" style="display: none">
            		...
            		<div class="editSelect" id="divHighestDegree" >
                    	<div class="viewBelow" onclick="showBelow('divSelectHighestDegreeValue')" id="viewBelowHighestDegree">
                        	<div id="selectHighestDegreeValue">选择存储专辑</div>
               ...
               <div class="inp">
               		<input class="inputup" type="button" value="开始上传">
					<input class="finished" type="button" value="完成" onclick="gotoNewPage()"/>
               </div>
        </div>
    </div>
    <!--内容-->
