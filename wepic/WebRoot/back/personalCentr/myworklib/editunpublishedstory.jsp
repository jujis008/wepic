...
storyform.action="story!editstory.do?flag="+id+"&storyId="+storyId;  
storyform.submit();   
}
                        ...
                        <li>
                        	<div id="divTopBarPats">
                            	<div id="topBarPats" class="topBarContainer">
                                	<a href="<%= basePath%>catBid!findByrootType.do"><span>我的约拍</span></a>
                                </div>
                ...
                <div class="right">
                    ...
                    <div class="divbottom">
                        ...
                        <div class="picin">
                            ...
                            <span class="picnum"><s:property value="story.detailpicNum"/></span>张
                            <span class="zzs">总字数</span>
                            <span class="picnum"><s:property value="story.detailtextNum"/></span>字
                        </div>
                    </div>
        	...
        	<div class="choosed">
            	<div class="con">
        			<div id="divAddEnTagpho">
            			...
            			<div id="42" class="retag">
						<input type="hidden" name="temppublishcat" value="<s:property value="#catstory.publishCat.id"/>" />
						<span><s:property value="#catstory.publishCat.name"/></span>
						<a onclick="deleteProModelPic(this);" title="删除"></a>
						</div>
            			</s:iterator>
            		</div>
            ...
            <div class="choosed">
        		<div class="con">
                    ...
                    <s:iterator value="storytags" var="mytag">
	                    <div class="tag">
	                    <input type="hidden" value="<s:property value='#mytag' />" name="mytags"></input>
						<span>
