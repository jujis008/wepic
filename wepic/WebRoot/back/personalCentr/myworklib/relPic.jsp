...
<title>wepic管理_个人中心_我的作品库_发布图片</title>
...
<link type="text/css" rel="stylesheet" href="<%=basePath %>back/personalCentr/myworklib/css/relPic.css" />
...
<!-- 头部结束-->
    ...
    <div id="divRelWork">
   		<div class="character">
        	<span class="upl">发布图片</span>
        	<span class="more">展示图片尺寸最大边不应小于1000px，可出售图片尺寸最大边应小于3000px。</span>
        ...
        <div class="divAddPic">
        	...
        	<div class="right">
            	<div class="title">
                    <span>图片标题</span>
                    <i>
                    <input  class="texttitle" type="text" id="texttitleinp" value="<s:property value="publish.name"/>" name="name"  onblur="promptInfo('texttitleinp','titleprompt',40);"/></i>
                    
                    <input type="hidden" value="<s:property value="publish.logo"/>" id="piclogo" />
                    <span>作品类别
                ...
                <div class="storyDe">
                    ...
                    <div class="changk">
                        ...
                        <input type="text" class="textedit" name="height"/>px
                    </div>
                    <div class="jingdu">
                    	<span class="c">作品精度：</span>
                        <input type="text" class="textedit" name="psdPrecision" />dpi
                    </div>
                    </s:if>
        ...
        <div class="priceInfoOne priceInfoOnem">
            ...
            <div class="divuserq">
            	<input type="checkbox" id="checkuesr" name="copyrightType" value="1"  onchange="changeuse(this,'inpcheckuesr')"/>
         ...
         <div class="priceInfoOne">
            ...
            <div class="divuserq">
            	<input type="checkbox" id="checkuesr" onchange="changeuse(this,'inpcheckuesr2')" name="copyrightType" value="1"/>
        ...
        <div class="copyrightValue" >
        	<div class="left">
            	<div class="one">
            		<input type="checkbox" value="2" id="portraRight" class="che" name="portraRight" onchange="changexkxy(this,'butportraRight','deletecklass1')"/>
                ...
                <div class="one two">
            		<input type="checkbox" name="portraRight" id="realRight" value="2" class="che" onchange="changexkxy(this,'fileiploadwuquan',2,'deletecklass2')"/>
