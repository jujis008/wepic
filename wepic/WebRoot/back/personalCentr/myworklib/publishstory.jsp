...
<!-- 头部结束-->
     ...
     <!-- 导航 -->
  	<div id="assistantBar">
        ...
        <div class="threeStage">
            ...
            <a href="javascript:"><div class='bar active'><span>发布作品</span><i></i></div></a>
        </div>
        </div>
    </div>
    <!-- 导航  end-->
    ...
    <div id="divRelWork">
        	...
        	<div class="head">
                ...
                <div class="right">
                    ...
                    <div class="editSelect" id="divHighestDegree" >
                        ...
                        <a class="addzj" href="javascript:">管理专辑</a>
        ...
        <div class="priceInfoOne priceInfoOnem">
            ...
            <div class="divuserq">
            	<input type="checkbox" name="copyrightres" value="0" id="checkuesr"  onchange="changeuse(this,'inpcheckuesr')"/>
         ...
         <div class="priceInfoOne">
            ...
            <div class="divuserq">
            	<input type="checkbox" name="copyrightres" value="1"  id="checkuesr" onchange="changeuse(this,'inpcheckuesr2')"/>
        ...
        <div class="submit">
               <div class="inp">
					...
					<input class="finished" type="button" value="发布" onclick="mysmt();">
               </div>
        </div>
    </div>
    </form>
