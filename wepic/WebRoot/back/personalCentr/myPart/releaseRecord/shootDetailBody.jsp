...
function  chagePage(){
	   $("#divListThree").html('<iframe frameborder="0" id="invitedPerson" scrolling="false" src="responseInvitednew!lisetSetPerople.do?id=<s:property value="id"/>" height="1127px" width="863px"> </iframe>');
    //  alert("ssss");
    ...
    <!--中间内容-->
            ...
            <div class="divInviteBids">
          	<table>
                	<tr>
                        ...
                        <s:if test="bid.shootingEnvironment==1">
                                                                                      内景拍摄</s:if>
                     ...
                     <s:if test="bid.photoType==0">拍摄方式不限</s:if>
        ...
        <div id="appointProjectTimelyState">
        	...
        	<div class="divStateCard">
            	<input class="white_button" type="button" id="stateCardBackDetail" value="返回详情页" onclick="showDetail();"/>
                ...
                <div id="recruitCameristSmall">
                	<div class="recruitCameristSmall_one">
                    	<div class="shaixuan actives">新应约</div>
                    	<div class="shaixuan">全部应约者</div>
                    	<div class="shaixuan">不选的人</div>
                    </div>
                	<div class="recruitCameristSmall_two">
                    	<div class="shaixuan actives">全部</div>
                    	<div class="shaixuan">已回应</div>
                    	<div class="shaixuan">无回应</div>
                    </div>
                	<div class="recruitCameristSmall_three">
                    	
                    </div>
                	<div class="recruitCameristSmall_four">
                    	<div class="shaixuan actives">新应约</div>
                    	<div class="shaixuan">全部应约者</div>
                    	<div class="shaixuan">不选的人</div>
                    </div>
            ...
            <!--应约者列表-->
                ...
                <!--非模特-->
                 ...
                 <iframe frameborder="0" scrolling="false" src="${pageContext.request.contextPath}/responseInvitednew!findlistApplyBid.do?flag=1&id=<s:property value="bid.id"/>"  height="1827px" width="863px">
               </iframe>
                <!--翻页-->
                </div>
            ...
            <!--邀请记录-->
        		<div class="divList" id="divListTwo">
                     <iframe frameborder="0" id="invitedPerson" scrolling="false" src="${pageContext.request.contextPath}/responseInvitednew!isInvitedForMyBid.do?id=<s:property value="bid.id"/>&flag=1"  height="1407px" width="863px">
            ...
            <!--待定列表-->
                ...
                <iframe frameborder="0" scrolling="false" src="${pageContext.request.contextPath}/responseInvitednew!findlistApplyBid.do?id=<s:property value="bid.id"/>"  height="1127px" width="863px">
               </iframe>	
               
               <!--呃呃呃
                <iframe frameborder="0" id="invitedPerson" scrolling="false" src="${pageContext.request.contextPath}/back/personalCentr/myPart/releaseRecord/bidPersons/listsubstitution.jsp"  height="1127px" width="863px">
                </iframe>	
                翻页-->
                </div>
            ...
            <!--待定列表--> 
                ...
                <!--还有一人款项未结-->
                      <iframe frameborder="0" id="listsuccessfultenderer" scrolling="false" src="${pageContext.request.contextPath}/back/personalCentr/myPart/releaseRecord/bidPersons/listsuccessfultenderer.jsp"  height="1657px" width="863px">
               </iframe>	
        ...
        <!--款项已结清 -->
        	<div class="projectInfo">
            	...
            	<div class="filtrate">
                    ...
                    <a href="javascript:" class="invoice">我要开发票</a>
                    <!--<a href="javascript:" class="invoiced">我已开发票</a>-->
                </div>
        ...
        <!--交付日期已过-->  
         ...
         <!--中标者  交付日期已过 -->
        	<div class="projectInfo">
            	<div class="choose_person">
                	<span class="">中标人数：</span>
                	<span class="">134人</span>
                </div>
                
            	<div class="choose_personNo">
                	<span class="">还有</span>
                	<span class="wjqnum">134</span>
                	<span class="">人款项未结清</span>
                </div>
