...
<title>wepic管理_个人中心_我的约拍_发布约拍_个人写真</title>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/back/personalCentr/myPart/js/releaseShoot_xz.js"></script>
        	...
        	<div class="divChooseCon">
                	...
                	<div class="productType">
                    	<div class="top">
                            ...
                            <div class="proType">
                            	...
                            	<!-- 
                					<li class="active"><span>个人写真</span><i></i></li>
                    				<li><span>婚纱</span><i></i></li>
              				      	      -->                              
                	...
                	<div class="productNum">
                        ...
                        <div class="shootWayCon shootWayjijia">
                            	<ul id="chooseShootjijia">
                					<li class="active"><span>按套</span><i></i></li>
                	...
                	<div class="shootUnitPrice">
                        ...
                        <div class="divPrice">
                        	<input class="priceinput" type="text" name="unitpriceProduct" 
                                    ...
                                    onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'0')}else{this.value=this.value.replace(/\D/g,'')}"/>
                            <span class="pricesp" id="yuanAndPer">元/套</span>
                        </div>
                        
                        <div class="divTotalPrice">总价：<span>34234</span>元
                        </div>
                        ...
                        <input type="hidden" value="" name="publicOrPrivate" id="publicOrPrivate" />
                        <div class="shootWayCon">
                ...
                <input  type="hidden" name="bidType" id="bidType" value="1"/>
                 ...
                 <input  type="hidden" name="unitpriceType" id="unitpriceType" value=""/>
                  <input  type="hidden" name="sumProductPhoto" id="sumProductPhoto" value="4"/>
                  
                  
            		<input class="finished" id="finished" type="button" onclick="verifyFormXz();" value="发布"/>
           		</div>
            </div>
