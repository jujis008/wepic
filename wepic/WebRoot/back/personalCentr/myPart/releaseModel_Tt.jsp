...
<title>wepic管理_个人中心_我的约拍_找模特_T台模特</title>
        	...
        	<div class="divChooseCon">
            	<div class="shootBar">
                	...
                	<!--  
                    	...
                    	<a href="releaseModel_Tt.html"><li class="active">T台模特</li></a>
                	...
                	<div class="productType">
                    	<div class="top">
                            ...
                            <div class="proType">
                            	...
                            	<!-- - 
                					<li class="active"><span>服装发布会</span><i></i></li>
                    				<li><span>手机秀</span><i></i></li>
 				                   	<li><span>珠宝秀</span><i></i></li>
                			    	<li><span>内衣秀</span><i></i></li>
                                    -->
                	...
                	<div class="shootTwo">
                        ...
                        <div class="shootCon shootType">
                            <ul id="chooseShootType">
                                <li class="active"><span>走秀</span><i></i></li>
                            </ul>
                        </div>-->
                ...
                <input  type="hidden" name="bidType" id="bidType" value="1"/>
                 ...
                 <input  type="hidden" name="unitpriceType" id="unitpriceType" value=""/>
                  <input  type="hidden" name="sumProductPhoto" id="sumProductPhoto" value="5"/>
            		...
            		<input class="finished" id="finished" type="button" onclick="verifyFormTt();" value="发布"/>
           		</div>
            </div>
