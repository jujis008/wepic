...
<title>wepic管理_个人中心_我的约拍_发布约拍_广告片/宣传片拍摄</title>
        ...
        function divLiBarClickProduct(divName){
        	...
        	$(allMainBarLi).each(function(){
        			$(this).click(function(){
        				...
        				$("#chooseShootjijia").html('<li class="active"><span>按片长</span><i></i></li><li><span>按天</span><i></i></li><li><span>按时</span><i></i></li>');
                	...
                	<div class="productType">
                    	<div class="top">
                            ...
                            <div class="proType">
                            	...
                            	<!--  
                					<li class="active"><span>电影广告片</span><i></i></li>
                    				<li><span>电视广告片</span><i></i></li>
 				                   	<li><span>新品发布广告片</span><i></i></li>
                			    	<li><span>活动广告片</span><i></i></li>
 				                   	<li><span>网络广告片</span><i></i></li>
                			    	<li><span>新媒体广告片</span><i></i></li>
 				                   	<li><span>企业宣传片</span><i></i></li>
                			    	<li><span>产品宣传片</span><i></i></li>
              				      	    -->                               
                ...
                <input  type="hidden" name="bidType" id="bidType" value="1"/>
                 ...
                 <input  type="hidden" name="unitpriceType" id="unitpriceType" value=""/>
                  <input  type="hidden" name="sumProductPhoto" id="sumProductPhoto" value="3"/>
            		...
            		<input class="finished" id="finished" type="button" onclick="verifyFormGg();" value="发布"/>
           		</div>
            </div>
