        	...
        	<div class="divChooseCon">
                ...
                <div class="divInfo">
                    ...
                    <td>
                      ...
                      <td>
                     <span class="chooseIn" id="fileipload">选择文件</span>
                    </td>
                              ...
                              <div class="rightc">
                            <div id="ULUpload" class="tableUpload">
                                    <ul>
                                    <!-- 
                                    <li class="">
                                        <div class="success">
                                            <div class="contenttd">
                                                <div class="divtd"><i class="file"></i><i title="上传成功" class="true"></i></div>
                                                <div title="这里是全名称" class="infos">附件三等份收复失地附件三等份收复失地附件附件三等份收复失地附件附件三等份收复失地附件1111111111111111111111111111.pdf(56.KB)</div>
                                            </div>
                                            
                                            <div class="bjcon">
                                                <div class="bj"></div>
                                                <div class="bjc"><i onclick="deleteFile(this);" title="删除" class="del"></i></div>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="">
                                        <div class="faled">
                                            <div class="contenttd">
                                                <div class="divtd"><i class="file"></i><i title="上传失败" class="false"></i></div>
                                                <div title="这里是全名称" class="infosf">附件三等份附件三等份收附件三等份收收附件三等份收.pdf(56.KB)</div>
                                                <div class="infosf2">上传失败</div>
                                            </div>
                                            <div class="bjcon">
                                                <div class="bj"></div>
                                                <div class="bjc">
                                                    <i title="重新上传" class="reload"></i>
                                                    <i onclick="deleteFile(this);" title="删除" class="del"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="">
                                        <div class="loadingtd">
                                            ...
                                            <div class="loadingname2">
                                                <span>上传中...</span>
                                                <i onclick="deleteFile(this);" title="删除"></i>
                                            </div>
                                        </div>
                                    </li>
                                     -->
                ...
                <input  type="hidden"  name="attachmentUrl" id="attachmentUrl"/>
                   <input  type="hidden"  name="fileType" id="fileType"/>
                    ...
                    <input class="finished" id="finished" type="button" onclick="submit_Cytp();" value="发布"/>
                </div>
