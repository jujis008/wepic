...
divLiBarClick("chooseProductType");			//产品类型
...
function yyyyyyyy(){
	...
	$("#iframeChooseFriend").html('<iframe name="child" style="border:0px;width:875px;height:735px" src="chooseFriend.html"></iframe>');
