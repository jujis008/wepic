...
divLiBarClickProduct("chooseProductType");			//作品内容


divLiBarClick("chooseShootModel");			//格式要求
...
function divLiBarClickProduct(divName){
	...
	$(allMainBarLi).each(function(){
			$(this).click(function(){
				...
				$("#chooseShootModel").html('<li class="active"><span>不限</span><i></i></li><li><span>JPG</span><i></i></li><li><span>Tif</span><i></i></li><li><span>Psd</span><i></i></li><li><span>Ai</span><i></i></li><li><span>Cdr</span><i></i></li>');
				divLiBarClick("chooseShootModel");			//格式要求
				...
				if(value == "壁纸"){
					$("#chooseShootModel").html('<li class="active"><span>不限</span><i></i></li><li><span>JPG</span><i></i></li><li><span>Tif</span><i></i></li>');
					divLiBarClick("chooseShootModel");			//格式要求
					return;
					}
				else if(value == "游戏角色" || value == "游戏场景" || value == "卡通形象"){
					$("#chooseShootModel").html('<li class="active"><span>不限</span><i></i></li><li><span>JPG</span><i></i></li><li><span>Tif</span><i></i></li><li><span>Psd</span><i></i></li><li><span>Ai</span><i></i></li><li><span>Cdr</span><i></i></li><li><span>3DMax</span><i></i></li>');
					divLiBarClick("chooseShootModel");			//格式要求
					return;
					}
			});	
