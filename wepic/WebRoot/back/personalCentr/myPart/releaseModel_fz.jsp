...
<title>wepic管理_个人中心_我的约拍_找模特_服装试穿</title>
        	...
        	<div class="divChooseCon">
            	<div class="shootBar">
                	...
                	<s:if test="id==bidCat.id">
                    	...
                    	<a href="releaseModel_pm.html"><li class="active">平面广告</li></a>
                ...
                <div class="divInfo">
                	...
                	<div class="shootTwo">
                        ...
                        <div class="shootCon shootType">
                            <ul id="chooseShootType">
                                <li class="active"><span>拍摄</span><i></i></li>
                            </ul>
                        </div>-->
                	...
                	<div class="shootThree">
                        ...
                        <div class="time" id="choseTime"><input name="workStartTime" class="timeInputStr" id="txtBeginDate" type="text"/></div>
                        
                        
                    	<div class="character">交付日期</div>
                        <div class="time" id="choseTime2"><input name="workEndTime" class="timeInputStr" id="txtEndDate" type="text"/></div>
                ...
                <input  type="hidden" name="bidType" id="bidType" value="2"/>
                 ...
                 <input  type="hidden" name="unitpriceType" id="unitpriceType" value=""/>
                  <input  type="hidden" name="sumProductPhoto" id="sumProductPhoto" value="5"/>
            		...
            		<input class="finished" id="finished" type="button" onclick="verifyFormFz();" value="发布"/>
           		</div>
            </div>
