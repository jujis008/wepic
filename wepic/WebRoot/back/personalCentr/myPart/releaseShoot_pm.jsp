...
<title>wepic管理_个人中心_我的约拍_发布约拍_平面广告拍摄</title>
        	...
        	<div class="divChooseCon">
                ...
                <div class="divInfo">
                	<div class="productType">
                    	<div class="top">
                            ...
                            <div class="proType">
                            	...
                            	<!-- 
                					<li class="active"><span>人物拍摄</span><i></i></li>
                    				<li><span>场景拍摄</span><i></i></li>
 				                   	<li><span>厂区环境</span><i></i></li>
                			    	<li><span>创意广告</span><i></i></li>
              				      	          -->                          
                	...
                	<div class="shootTime">
                        ...
                        <div class="time" id="choseTime"><input class="timeInputStr" id="txtBeginDate" type="text" name="workStartTime"/></div>
