...
<title>wepic管理员_用户_实名认证待审核_企业_未通过列表</title>
    ...
    <div class="container_body">
        <div class="div_job">
            <ul class="ul_job" id="jobUl">
            	...
            	<li onclick="enterprisenopass()" class="active">企业</li>
      ...
      <div class="divStateCardCon">
          <div class="divList">
              ...
              <s:iterator value="pager.resultList" var="list">
                  <li class="enterpriseLi" onclick="checkorganizationdetailnopass(<s:property value="#list.id"/>)">
                      <div class="divImg">
        ...
        <div class="ppointPaging">            
            <table class="tablePpointPaging">
                	<tr>
                    	...
                    	<td class="ppointPagingOne"><a href="configure!adminenterprisenopasslist.do?pageNo=1"></a></td>
                    	<s:if test="pager.pageCount ==1">
                        <td class="ppointPagingPre"><a href="configure!adminenterprisenopasslist.do?pageNo=1"></a></td>
                        </s:if>
                        <s:else>
                        <td class="ppointPagingPre"><a href="configure!adminenterprisenopasslist.do?pageNo=<s:property value='pager.prePageNo'/>"></a></td>
                        </s:else>
         <s:param name="first" value="1"/>  
          <s:param name="last" value="pager.pageCount"/>  
          <s:iterator>  
          <s:if test="pager.pageNo==current-1">
          <td class="ppointPagingN"><a href="configure!adminenterprisenopasslist.do?pageNo=<s:property />"><s:property /></a></td>
          </s:if>
          <s:else>
            <td class="ppointPagingN"><a href="configure!adminenterprisenopasslist.do?pageNo=<s:property />"><s:property /></a></td>
          </s:else>
           ...
           <s:if test="pager.pageCount ==1"> 
           <td class="ppointPagingNext"><a href="configure!adminenterprisenopasslist.do?pageNo=1"></a></td>
           </s:if>
           <s:else >
           <td class="ppointPagingNext"><a href="configure!adminenterprisenopasslist.do?pageNo=<s:property value='pager.nextPageNo'/>"></a></td>
           </s:else>
           <td class="ppointPagingLast"><a href="configure!adminenterprisenopasslist.do?pageNo=<s:property value='pager.pageCount'/>"></a></td>
            </s:bean>  
