...
<title>wepic管理员_用户_实名认证待审核_媒体_单个审核</title>
...
$(function(){
        ...
        $.ajax({
  	      type:"Post",
  		  url: "configurajson_govermentprenext.do?userenterprisetype=2&userpersonOrCompany=2&userifIdentityTrue=1",
  		  data:"",		
    ...
    <div class="container_body">
        <div class="div_job">
            <ul class="ul_job">
            	...
            	<li onclick="media()" class="active">媒体</li>
