...
<title>wepic管理员_用户_实名认证待审核_企业_审核未通过</title>
...
$(function(){
        ...
        $.ajax({
  	      type:"Post",
  		  url: "configurajson_govermentprenext.do?userenterprisetype=3&userpersonOrCompany=2&userifIdentityTrue=3",
  		  data:"",		
...
<link type="text/css" rel="stylesheet" href="<%=basePath %>administrator/user/css/css/autonymAttestationCheckEnterpriseNoPass.css" />
</head>
        ...
        <div class="div_container">
        	<div class="left_Con">
                ...
                <div class="businessLicense_table">
                	<table>
                    	<tr>
                        	<td class="td_one">企业名称</td>
                        	<td class="td_two"><s:property value="user.companyName"/></td>
                        	<td class="td_one">成立时间</td>
                        	<td class="td_four"><s:property value="user.companyBuildDate"/></td>
                        </tr>
                    	<tr>
                        	<td class="td_one">企业邮箱</td>
                        	<td class="td_two"><s:property value="user.companyEmail"/></td>
                        	<td class="td_one">营业期限</td>
                        	<td class="td_four"><s:property value="user.busnissAllowedTime"/></td>
                        </tr>
                    	<tr>
                        	<td class="td_one">企业地址</td>
                        	<td class="td_two"><s:property value="user.companyAddr"/></td>
                        	<td class="td_one">注册资金</td>
                        	<td class="td_four"><s:property value="user.companyRegMoney"/></td>
                        </tr>
                    	<tr>
                        	<td class="td_one">营业执照所在地</td>
                        	<td class="td_two"><s:property value="user.companyRegAddr"/></td>
                        	<td class="td_one">组织机构代码</td>
                        	<td class="td_four"><s:property value="user.companyorgcode"/></td>
                        </tr>
                    	<tr>
                        	<td class="td_one">经营范围</td>
                        	<td class="td_two"><s:property value="user.businessScope"/></td>
                        	<td class="td_one">营业执照注册号</td>
                        	<td class="td_four"><s:property value="user.certificateNo"/></td>
                        </tr>
