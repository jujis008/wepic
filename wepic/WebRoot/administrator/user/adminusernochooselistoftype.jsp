        ...
        <div class="div_job">
           ...
           <div class='bar' onclick="allzhiye()"><span>全部职业</span><i></i></div>
              ...
              <s:iterator value="userCats" var="usercat">
            	...
            	<div class='bar active' onclick="adminusernochooselist(<s:property value="#usercat.id"/>)"><span>艺人</span><i></i></div>
            	</s:if>
            	<s:else>
            	<div class='bar active' onclick="adminusernochooselist(<s:property value="#usercat.id"/>)"><span><s:property value="#usercat.name"/></span><i></i></div>
            	</s:else>            	
            	</s:if>
            	<s:else>
            	<s:if test="#usercat.name == '演艺人士'">
            	<div class='bar' onclick="adminusernochooselist(<s:property value="#usercat.id"/>)"><span>艺人</span><i></i></div>
            	</s:if>
            	<s:else>
            	<div class='bar' onclick="adminusernochooselist(<s:property value="#usercat.id"/>)"><span><s:property value="#usercat.name"/></span><i></i></div>
            	</s:else>
            	</s:else>
            	</s:iterator>
<!--              <div class='bar active'><span>全部职业</span><i></i></div>-->
<!--              -->
<!--              <div class='bar'><span>摄影师</span><i></i></div>-->
<!--              -->
<!--              <div class='bar'><span>模特</span><i></i></div>-->
<!--              -->
<!--              <div class='bar'><span>经纪人</span><i></i></div>-->
<!--              -->
<!--              <div class='bar'><span>艺人</span><i></i></div>-->
<!--              -->
<!--              <div class='bar'><span>设计师</span><i></i></div>-->
        	...
        	<s:iterator value="pager.resultList" var="list">
            	<tr>
                    ...
                    <td class="td_laterThree">
                    	<div class="td_div_one">
                        	<span>用户类型:</span>
                        	<s:if test="#list.userCat.name == null">
                        	<span>暂缺</span>
                        	</s:if>
                            <s:else>
