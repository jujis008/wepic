...
function openPopUpBox(divPopUpBox){
	...
	$("#"+divPopUpBox).show();
	$("#"+divPopUpBox).css({ "position": "absolute","z-index":"10000","top":(scrollTop) + "px" , "left": topWidth+"px"});
...
/* 回顶部 */
function allorganiztion(){
	location.href="configure!adminorganizationcheck.do";
}
function allorganiztionnopass(){
	location.href="configure!adminorganizationnopasslist.do";
}
function government(){
	location.href="configure!adminorganizationcheckbygoverment.do";
}
function governmentnopass(){
	location.href="configure!admingovernmentnopasslist.do";
}
function media(){
	location.href="configure!adminorganizationcheckbymedia.do";
}
function medianopass(){
	location.href="configure!adminmedianopasslist.do";
}
function enterprise(){
	location.href="configure!adminorganizationcheckbyenterprise.do";
}
function enterprisenopass(){
	location.href="configure!adminenterprisenopasslist.do";
}
function other(){
	location.href="configure!adminorganizationcheckbyother.do";
}
function othernopass(){
	location.href="configure!adminothernopasslist.do";
}
function admindetailcheck(id){
	location.href="configure!admindetailcheck.do?userId="+id;
	}
function checkorganizationdetailnopass(id){
	location.href="configure!checkorganizationdetailnopass.do?userId="+id;
}
function adminpersoncheckbytype(id){
	location.href="configure!adminpersoncheckbytype.do?usercatId="+id;
}
function adminpersoncheckall(){
	location.href="configure!configure!adminpersoncheck.do";
}
function adminpersonnopassbytype(id){
	location.href="configure!adminpersonchecknopasslistbytype.do?usercatId="+id;
}
function adminpersonnopass(){
	location.href="configure!adminpersonchecknopasslist.do";
}
function adminpersontype(id){
	location.href="configure!adminpersontype.do?usercatId="+id;
}
function allzhiye(){
	location.href="configure!adminpersonlist.do?usercatId=0";
}
function adminuserorganizationofflag(flag){
	location.href="configure!adminorganizationlistoftype.do?flag="+flag;
}
//表格奇偶数行背景颜色
