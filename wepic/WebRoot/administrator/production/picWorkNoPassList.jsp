...
<title>wepic管理员_作品_摄影故事_未通过列表</title>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/administrator/production/js/picWorkNoPassList.js"></script>
                    	...
                    	<div class="phoStroyContentLi">
                         ...
                         <!--默认显示-->
                            ...
                            <div class="nowtop">
                        		<div class="bj"></div>
                        		<div class="bjc">
                                 <div class="viewBjCon" title="查看详情" onclick="window.location='${pageContext.request.contextPath}/publish!adminNoPassDetail.do?id=<s:property value="id"/>'">
                                    ...
                                    <div class="divDel">
                                    	 <a href="javascript:" class="directDel">直接删除</a>
                                    </div>   
                                </div>
                        	</div>
                            <!--鼠标滑过显示-->
