...
<!-- 头部结束-->
                	...
                	<div class="edit" id="editzpgs">
                    	...
                    	<div class="bjc">
                        	<div class="left">
                                ...
                                sfsfsf
                                 -->
                                 <s:if test="story.copyrightres == null">
                                 </s:if>
                                <s:if test="story.copyrightres == 0">
                                <s:if test="story.saleNum == 0">
                                <span class="sp1">￥</span>使用权未出售<span class="sp2">13</span>次
                                </s:if>
                                <s:else>
                                	<span class="sp1">￥</span>使用权已出售<span class="sp2"><s:property value="story.saleNum"/></span>次
                                </s:else>
                                </s:if>
                            	</div>
                            </div>
                        ...
                        <div class="noPassReason" id="noPassReason">
                            <div class="editNoPass">
                                ...
                                <s:generator separator="." val="story.nopassration">
                                            <s:iterator>
                                            <tr>
                                        <td class="td1"><input id="checkzjwt" type="checkbox" checked="checked" disabled="disabled"/></td>
                                 ...
                                 <tr class="other">
                                        ...
                                        <td class="otherCon"><label for="checkqit">其他</label><textarea disabled="disabled"> <s:property value="story.writereason"/> </textarea></td>
                                    </tr>
                                    <tr class="huifu">
                                        <td class="td1"><a class="directDel" href="story!adminchecksuc.do?storyId=<s:property value='story.id'/>">通过审核</a></td>
                                    </tr>
                                </s:if>
                                <s:else>
                                <s:generator separator="." val="story.nopassration">  
    ...
    <div id="cropHead" style="width:1130px;height:900px; z-index:100000000;display:none;overflow:hidden;">
    	<iframe name='child2' style="border:0px;width:1200px;height:900px;overflow:hidden;z-index:100000000" src="<%=basePath %>public/cropHead.html"></iframe>
    </div>
