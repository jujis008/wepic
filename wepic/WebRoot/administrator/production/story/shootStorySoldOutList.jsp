...
<script type="text/javascript" src="<%=basePath %>administrator/production/js/shootStorySoldOutList.js"></script>
<script type="text/javascript">
function searchsoldout(id){
location.href="story!searchadminsoldout.do?storyId="+id;
}
	function recoverupload(id){
	   if(confirm("确定要恢复该摄影故事吗?"))
		{
		        location.href="story!recoverupload.do?storyId="+id;
		}
	}
</script>
<link type="text/css" rel="stylesheet" href="<%=basePath %>administrator/production/css/shootStorySoldOutList.css" />
</head>
                	...
                	<li>
                    	<div class="phoStroyContentLi">
                            ...
                            <div class="nowtop">
                        		<div class="bj"></div>
                        		<div class="bjc">
                                	<div class="viewBjCon" title="查看详情" onclick="searchsoldout(<s:property value="#list.id"/>)">
                                        <div class="picInf">
                                        ...
                                        <div class="divNoPassRea">
                                            ...
                                            <div class="rea">暂无</div>
                                            </s:if>
                                            <s:else>
                                            <div class="rea">① <s:property value="#list.soldoutreason"/> </div>
                                            </s:else>
                                        </div>
                                    </div>
                                    
                                    <div class="divDel">
                                    	 <a href="story!admindelstoryofsoldout.do?storyId=<s:property value="#list.id"/>" class="directDel">直接删除</a>
                                    	 <a  onclick="recoverupload(<s:property value="#list.id"/>)" href="javascript:void(0)" class="directHF">恢复发布</a>
                                    </div>   
                                </div>
                        	</div>
                            <!--鼠标滑过显示-->
