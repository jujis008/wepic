...
<title>wepic管理员_作品_图片作品_单个审核</title>
        ...
        <!--右部内容-->
         	<div class="phoStroyDetailRight">
                ...
                <div class="storyCon">
                    ...
                    <input type="hidden" value="<s:property value="publish.id"/>" name="id" id="noPassId"/>
                    </td>
                ...
                <input type="hidden" id="hiddenSave"/>
                	...
                	<div class="autonyMaudit" id="autonyMaudit">
                    	...
                    	<div class="opeation">
							...
							<input class="noPass" type="button" value="通过" onclick="window.location.href='${pageContext.request.contextPath}/publish!adminPassPhoto.do?id=<s:property value="publish.id"/>'"/>
                        </div>
                    </div>
                    <!--操作是否通过-->
