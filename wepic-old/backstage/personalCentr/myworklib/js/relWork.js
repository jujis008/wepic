...
function addOwnBox(url){
	...
	option = "<div class='addcon-de'><a class='delcon' href='javascript:' onclick='delcon(this);'>×</a><div class='head'><img src='" + urlc + "' /></div><div class='area'><textarea></textarea></div></div>";
